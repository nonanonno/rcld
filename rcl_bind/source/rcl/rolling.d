 ...
 */
        alias rcl_allocator_t = rcutils_allocator_s;

        alias __intptr_t = c_long;

        alias __caddr_t = char*;

        alias rcl_arguments_impl_t = rcl_arguments_impl_s;
        struct rcl_arguments_impl_s;
        /// Hold output of parsing command line arguments.
        alias rcl_arguments_t = rcl_arguments_s;
        /// Hold output of parsing command line arguments.
        struct rcl_arguments_s
        {
            /// Private implementation pointer.
            rcl_arguments_impl_s* impl;
        }
        ...
        rcl_arguments_s rcl_get_zero_initialized_arguments() @nogc nothrow;
 ...
 */
        int rcl_parse_arguments(int, const(const(char)*)*,
                rcutils_allocator_s, rcl_arguments_s*) @nogc nothrow;
 ...
 */
        int rcl_arguments_get_count_unparsed(const(rcl_arguments_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_arguments_get_unparsed(const(rcl_arguments_s)*, rcutils_allocator_s, int**) @nogc nothrow;
 ...
 * \return -1 if args is `NULL` or zero initialized.
 */
        int rcl_arguments_get_count_unparsed_ros(const(rcl_arguments_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_arguments_get_unparsed_ros(const(rcl_arguments_s)*, rcutils_allocator_s, int**) @nogc nothrow;
 ...
 * \return -1 if args is `NULL` or zero initialized.
 */
        int rcl_arguments_get_param_files_count(const(rcl_arguments_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_arguments_get_param_files(const(rcl_arguments_s)*, rcutils_allocator_s, char***) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_arguments_get_param_overrides(const(rcl_arguments_s)*, rcl_params_s**) @nogc nothrow;
 ...
 */
        int rcl_remove_ros_arguments(const(const(char)*)*,
                const(rcl_arguments_s)*, rcutils_allocator_s, int*, const(char)***) @nogc nothrow;
 ...
 */
        int rcl_arguments_get_log_levels(const(rcl_arguments_s)*, rcl_log_levels_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_arguments_copy(const(rcl_arguments_s)*, rcl_arguments_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_arguments_fini(rcl_arguments_s*) @nogc nothrow;
        /// Internal rcl client implementation struct.
        alias rcl_client_impl_t = rcl_client_impl_s;
        struct rcl_client_impl_s;
        /// Structure which encapsulates a ROS Client.
        alias rcl_client_t = rcl_client_s;
        /// Structure which encapsulates a ROS Client.
        struct rcl_client_s
        {
            /// Pointer to the client implementation
            rcl_client_impl_s* impl;
        }
        /// Options available for a rcl_client_t.
        alias rcl_client_options_t = rcl_client_options_s;
        /// Options available for a rcl_client_t.
        struct rcl_client_options_s
        {
            /// Middleware quality of service settings for the client.
            rmw_qos_profile_s qos;
 ...
 * rcl_client_init().
 */
        rcl_client_s rcl_get_zero_initialized_client() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_client_init(rcl_client_s*, const(rcl_node_s)*,
                const(rosidl_service_type_support_t)*, const(char)*,
                const(rcl_client_options_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_client_fini(rcl_client_s*, rcl_node_s*) @nogc nothrow;
 ...
 */
        rcl_client_options_s rcl_client_get_default_options() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_send_request(const(rcl_client_s)*, const(void)*, c_long*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_take_response_with_info(const(rcl_client_s)*, rmw_service_info_s*, void*) @nogc nothrow;
        /// backwards compatibility function that takes a rmw_request_id_t only
        int rcl_take_response(const(rcl_client_s)*, rmw_request_id_s*, void*) @nogc nothrow;
 ...
 */
        const(char)* rcl_client_get_service_name(const(rcl_client_s)*) @nogc nothrow;
 ...
 */
        const(rcl_client_options_s)* rcl_client_get_options(const(rcl_client_s)*) @nogc nothrow;
 ...
 */
        rmw_client_s* rcl_client_get_rmw_handle(const(rcl_client_s)*) @nogc nothrow;
 ...
 */
        bool rcl_client_is_valid(const(rcl_client_s)*) @nogc nothrow;
 ...
 */
        const(rmw_qos_profile_s)* rcl_client_request_publisher_get_actual_qos(const(rcl_client_s)*) @nogc nothrow;
 ...
 * \return qos struct if successful, otherwise `NULL`
 */
        const(rmw_qos_profile_s)* rcl_client_response_subscription_get_actual_qos(
                const(rcl_client_s)*) @nogc nothrow;
 ...
 */
        int rcl_client_set_on_new_response_callback(const(rcl_client_s)*,
                void function(const(void)*, c_ulong), const(void)*) @nogc nothrow;

        alias __fsfilcnt64_t = c_ulong;
        /// A unique ID per context instance.
        alias rcl_context_instance_id_t = c_ulong;

        alias rcl_context_impl_t = rcl_context_impl_s;
 ...
 */
        alias rcl_context_t = rcl_context_s;
        /// Encapsulates the non-global state of an init/shutdown cycle.
        /**
 * The context is used in the creation of top level entities like nodes and
 * guard conditions, as well as to shutdown a specific instance of init.
 ...
 */
        struct rcl_context_s
        {
            ...
            rcl_arguments_s global_arguments;
            /// Implementation specific pointer.
            rcl_context_impl_s* impl;
            /// @endcond
   ...
   */
        ...
        rcl_context_s rcl_get_zero_initialized_context() @nogc nothrow;
        /// Finalize a context.
        /**
 ...
 */
        int rcl_context_fini(rcl_context_s*) @nogc nothrow;
 ...
 */
        const(rcl_init_options_s)* rcl_context_get_init_options(const(rcl_context_s)*) @nogc nothrow;
 ...
 */
        c_ulong rcl_context_get_instance_id(const(rcl_context_s)*) @nogc nothrow;
 ...
 */
        int rcl_context_get_domain_id(rcl_context_s*, c_ulong*) @nogc nothrow;
 ...
 */
        bool rcl_context_is_valid(const(rcl_context_s)*) @nogc nothrow;
 ...
 */
        rmw_context_s* rcl_context_get_rmw_context(rcl_context_s*) @nogc nothrow;
 ...
 */
        ...
        alias rcl_publisher_event_type_t = rcl_publisher_event_type_e;
        /// Enumeration of all of the publisher events that may fire.
        ...
        enum RCL_PUBLISHER_OFFERED_DEADLINE_MISSED = rcl_publisher_event_type_e
                .RCL_PUBLISHER_OFFERED_DEADLINE_MISSED;
        enum RCL_PUBLISHER_LIVELINESS_LOST = rcl_publisher_event_type_e
                .RCL_PUBLISHER_LIVELINESS_LOST;
        enum RCL_PUBLISHER_OFFERED_INCOMPATIBLE_QOS = rcl_publisher_event_type_e
                .RCL_PUBLISHER_OFFERED_INCOMPATIBLE_QOS;
        /// Enumeration of all of the subscription events that may fire.
        alias rcl_subscription_event_type_t = rcl_subscription_event_type_e;
        /// Enumeration of all of the subscription events that may fire.
        ...
        enum RCL_SUBSCRIPTION_REQUESTED_DEADLINE_MISSED = rcl_subscription_event_type_e
                .RCL_SUBSCRIPTION_REQUESTED_DEADLINE_MISSED;
        enum RCL_SUBSCRIPTION_LIVELINESS_CHANGED = rcl_subscription_event_type_e
                .RCL_SUBSCRIPTION_LIVELINESS_CHANGED;
        enum RCL_SUBSCRIPTION_REQUESTED_INCOMPATIBLE_QOS = rcl_subscription_event_type_e
                .RCL_SUBSCRIPTION_REQUESTED_INCOMPATIBLE_QOS;
        enum RCL_SUBSCRIPTION_MESSAGE_LOST = rcl_subscription_event_type_e
                .RCL_SUBSCRIPTION_MESSAGE_LOST;
        /// Internal rcl implementation struct.
        alias rcl_event_impl_t = rcl_event_impl_s;
        struct rcl_event_impl_s;
        /// Structure which encapsulates a ROS QoS event handle.
        alias rcl_event_t = rcl_event_s;
        /// Structure which encapsulates a ROS QoS event handle.
        struct rcl_event_s
        {
            /// Pointer to the event implementation
            rcl_event_impl_s* impl;
        }
 ...
 */
        rcl_event_s rcl_get_zero_initialized_event() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publisher_event_init(rcl_event_s*, const(rcl_publisher_s)*,
                const(rcl_publisher_event_type_e)) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_subscription_event_init(rcl_event_s*,
                const(rcl_subscription_s)*, const(rcl_subscription_event_type_e)) @nogc nothrow;
        /**
 ...
 */
        int rcl_take_event(const(rcl_event_s)*, void*) @nogc nothrow;
        /**
 * Finalize an event.
 *
 ...
 * \return #RCL_RET_ERROR if an unexpected error occurs.
 */
        int rcl_event_fini(rcl_event_s*) @nogc nothrow;
 ...
 */
        rmw_event_s* rcl_event_get_rmw_handle(const(rcl_event_s)*) @nogc nothrow;
 ...
 */
        bool rcl_event_is_valid(const(rcl_event_s)*) @nogc nothrow;
 ...
 * \return `RCL_RET_UNSUPPORTED` if the API is not implemented in the dds implementation
 */
        int rcl_event_set_callback(const(rcl_event_s)*,
                void function(const(void)*, c_ulong), const(void)*) @nogc nothrow;
        alias rcl_event_callback_t = void function(const(void)*, c_ulong);
        /// A structure that contains topic names and types.
        alias rcl_names_and_types_t = rmw_names_and_types_s;
        /// A structure that encapsulates the node name, node namespace,
        /// topic type, gid, and qos_profile or publishers and subscriptions
        /// for a topic.
        alias rcl_topic_endpoint_info_t = rmw_topic_endpoint_info_s;
        /// An array of topic endpoint information.
        alias rcl_topic_endpoint_info_array_t = rmw_topic_endpoint_info_array_s;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_publisher_names_and_types_by_node(const(rcl_node_s)*,
                rcutils_allocator_s*, bool, const(char)*, const(char)*, rmw_names_and_types_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_subscriber_names_and_types_by_node(const(rcl_node_s)*,
                rcutils_allocator_s*, bool, const(char)*, const(char)*, rmw_names_and_types_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_service_names_and_types_by_node(const(rcl_node_s)*,
                rcutils_allocator_s*, const(char)*, const(char)*, rmw_names_and_types_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_client_names_and_types_by_node(const(rcl_node_s)*,
                rcutils_allocator_s*, const(char)*, const(char)*, rmw_names_and_types_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_topic_names_and_types(const(rcl_node_s)*,
                rcutils_allocator_s*, bool, rmw_names_and_types_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_service_names_and_types(const(rcl_node_s)*,
                rcutils_allocator_s*, rmw_names_and_types_s*) @nogc nothrow;
 ...
 */
        int rcl_names_and_types_init(rmw_names_and_types_s*, c_ulong, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_names_and_types_fini(rmw_names_and_types_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_node_names(const(rcl_node_s)*, rcutils_allocator_s,
                rcutils_string_array_s*, rcutils_string_array_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_node_names_with_enclaves(const(rcl_node_s)*, rcutils_allocator_s,
                rcutils_string_array_s*, rcutils_string_array_s*, rcutils_string_array_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_count_publishers(const(rcl_node_s)*, const(char)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_count_subscribers(const(rcl_node_s)*, const(char)*, c_ulong*) @nogc nothrow;
 ...
 */
        int rcl_wait_for_publishers(const(rcl_node_s)*, rcutils_allocator_s*,
                const(char)*, const(c_ulong), c_long, bool*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurred.
 */
        int rcl_wait_for_subscribers(const(rcl_node_s)*,
                rcutils_allocator_s*, const(char)*, const(c_ulong), c_long, bool*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_publishers_info_by_topic(const(rcl_node_s)*, rcutils_allocator_s*,
                const(char)*, bool, rmw_topic_endpoint_info_array_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_get_subscriptions_info_by_topic(const(rcl_node_s)*,
                rcutils_allocator_s*, const(char)*, bool, rmw_topic_endpoint_info_array_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_service_server_is_available(const(rcl_node_s)*, const(rcl_client_s)*, bool*) @nogc nothrow;

        alias __blkcnt64_t = c_long;
        /// Internal rcl guard condition implementation struct.
        alias rcl_guard_condition_impl_t = rcl_guard_condition_impl_s;
        struct rcl_guard_condition_impl_s;
        /// Handle for a rcl guard condition.
        alias rcl_guard_condition_t = rcl_guard_condition_s;
        /// Handle for a rcl guard condition.
        struct rcl_guard_condition_s
        {
            /// Context associated with this guard condition.
            rcl_context_s* context;
            /// Pointer to the guard condition implementation
            rcl_guard_condition_impl_s* impl;
        }
        /// Options available for a rcl guard condition.
        alias rcl_guard_condition_options_t = rcl_guard_condition_options_s;
        /// Options available for a rcl guard condition.
        ...
        rcl_guard_condition_s rcl_get_zero_initialized_guard_condition() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_guard_condition_init(rcl_guard_condition_s*, rcl_context_s*,
                const(rcl_guard_condition_options_s)) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_guard_condition_init_from_rmw(rcl_guard_condition_s*,
                const(rmw_guard_condition_s)*, rcl_context_s*,
                const(rcl_guard_condition_options_s)) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_guard_condition_fini(rcl_guard_condition_s*) @nogc nothrow;
 ...
 */
        rcl_guard_condition_options_s rcl_guard_condition_get_default_options() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_trigger_guard_condition(rcl_guard_condition_s*) @nogc nothrow;
 ...
 */
        const(rcl_guard_condition_options_s)* rcl_guard_condition_get_options(
                const(rcl_guard_condition_s)*) @nogc nothrow;
 ...
 */
        rmw_guard_condition_s* rcl_guard_condition_get_rmw_handle(const(rcl_guard_condition_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_init(int, const(const(char)*)*, const(rcl_init_options_s)*, rcl_context_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occur.
 */
        int rcl_shutdown(rcl_context_s*) @nogc nothrow;

        alias rcl_init_options_impl_t = rcl_init_options_impl_s;
        struct rcl_init_options_impl_s;
        /// Encapsulation of init options and implementation defined init options.
        alias rcl_init_options_t = rcl_init_options_s;
        /// Encapsulation of init options and implementation defined init options.
        struct rcl_init_options_s
        {
            /// Implementation specific pointer.
            rcl_init_options_impl_s* impl;
        }
        /// Return a zero initialized rcl_init_options_t struct.
        rcl_init_options_s rcl_get_zero_initialized_init_options() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_init_options_init(rcl_init_options_s*, rcutils_allocator_s) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_init_options_copy(const(rcl_init_options_s)*, rcl_init_options_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_init_options_fini(rcl_init_options_s*) @nogc nothrow;
 ...
 */
        int rcl_init_options_get_domain_id(const(rcl_init_options_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCL_RET_INVALID_ARGUMENT if any arguments are invalid.
 */
        int rcl_init_options_set_domain_id(rcl_init_options_s*, c_ulong) @nogc nothrow;
 ...
 * \return `NULL` if there was an error
 */
        rmw_init_options_s* rcl_init_options_get_rmw_init_options(rcl_init_options_s*) @nogc nothrow;
 ...
 * \return `NULL` if there was an error
 */
        const(rcutils_allocator_s)* rcl_init_options_get_allocator(const(rcl_init_options_s)*) @nogc nothrow;
        /// typedef for RCUTILS_LOG_SEVERITY;
        alias rcl_log_severity_t = RCUTILS_LOG_SEVERITY;
        /// A logger item to specify a name and a log level.
        alias rcl_logger_setting_t = rcl_logger_setting_s;
        /// A logger item to specify a name and a log level.
        ...
        alias rcl_log_levels_t = rcl_log_levels_s;
        /// Hold default logger level and other logger setting.
        struct rcl_log_levels_s
        {
            /// Minimum default logger level severity.
            RCUTILS_LOG_SEVERITY default_logger_level;
            /// Array of logger setting.
            rcl_logger_setting_s* logger_settings;
            /// Number of logger settings.
            c_ulong num_logger_settings;
            /// Capacity of logger settings.
            c_ulong capacity_logger_settings;
 ...
 * \return a rcl_log_levels_t struct with members initialized to zero value.
 */
        rcl_log_levels_s rcl_get_zero_initialized_log_levels() @nogc nothrow;
 ...
 * \return #RCL_RET_BAD_ALLOC if allocating memory failed.
 */
        int rcl_log_levels_init(rcl_log_levels_s*, const(rcutils_allocator_s)*, c_ulong) @nogc nothrow;
 ...
 * \return #RCL_RET_BAD_ALLOC if allocating memory failed.
 */
        int rcl_log_levels_copy(const(rcl_log_levels_s)*, rcl_log_levels_s*) @nogc nothrow;
 ...
 */
        int rcl_log_levels_fini(rcl_log_levels_s*) @nogc nothrow;
 ...
 */
        int rcl_log_levels_shrink_to_size(rcl_log_levels_s*) @nogc nothrow;
 ...
 */
        int rcl_log_levels_add_logger_setting(rcl_log_levels_s*,
                const(char)*, RCUTILS_LOG_SEVERITY) @nogc nothrow;

        alias __blkcnt_t = c_long;

        alias __blksize_t = c_long;

        extern __gshared const(const(char)*) RCL_DISABLE_LOANED_MESSAGES_ENV_VAR;

        alias rcl_node_impl_t = rcl_node_impl_s;
        struct rcl_node_impl_s;
        /// Structure which encapsulates a ROS Node.
        alias rcl_node_t = rcl_node_s;
        /// Structure which encapsulates a ROS Node.
        struct rcl_node_s
        {
            ...
            rcl_context_s* context;
            /// Private implementation pointer.
            rcl_node_impl_s* impl;
        }
        /// Return a rcl_node_t struct with members initialized to `NULL`.
        rcl_node_s rcl_get_zero_initialized_node() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_node_init(rcl_node_s*, const(char)*, const(char)*,
                rcl_context_s*, const(rcl_node_options_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_node_fini(rcl_node_s*) @nogc nothrow;
 ...
 */
        bool rcl_node_is_valid(const(rcl_node_s)*) @nogc nothrow;
 ...
 */
        bool rcl_node_is_valid_except_context(const(rcl_node_s)*) @nogc nothrow;
 ...
 * \return name string if successful, otherwise `NULL`
 */
        const(char)* rcl_node_get_name(const(rcl_node_s)*) @nogc nothrow;
 ...
 * \return name string if successful, otherwise `NULL`
 */
        const(char)* rcl_node_get_namespace(const(rcl_node_s)*) @nogc nothrow;
 ...
 */
        const(char)* rcl_node_get_fully_qualified_name(const(rcl_node_s)*) @nogc nothrow;
 ...
 * \return options struct if successful, otherwise `NULL`
 */
        const(rcl_node_options_s)* rcl_node_get_options(const(rcl_node_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_node_get_domain_id(const(rcl_node_s)*, c_ulong*) @nogc nothrow;
 ...
 */
        rmw_node_s* rcl_node_get_rmw_handle(const(rcl_node_s)*) @nogc nothrow;
 ...
 */
        c_ulong rcl_node_get_rcl_instance_id(const(rcl_node_s)*) @nogc nothrow;
 ...
 */
        const(rcl_guard_condition_s)* rcl_node_get_graph_guard_condition(const(rcl_node_s)*) @nogc nothrow;
 ...
 */
        const(char)* rcl_node_get_logger_name(const(rcl_node_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_node_resolve_name(const(rcl_node_s)*, const(char)*,
                rcutils_allocator_s, bool, bool, char**) @nogc nothrow;
 ...
 * \return #RCL_RET_OK.
 */
        int rcl_get_disable_loaned_message(bool*) @nogc nothrow;
        /// Structure which encapsulates the options for creating a rcl_node_t.
        alias rcl_node_options_t = rcl_node_options_s;
        /// Structure which encapsulates the options for creating a rcl_node_t.
        struct rcl_node_options_s
        {
            ...
            rcl_arguments_s arguments;
            /// Flag to enable rosout for this node
            bool enable_rosout;
            /// Middleware quality of service settings for /rosout.
            rmw_qos_profile_s rosout_qos;
        }
 ...
 */
        rcl_node_options_s rcl_node_get_default_options() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_node_options_copy(const(rcl_node_options_s)*, rcl_node_options_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_node_options_fini(rcl_node_options_s*) @nogc nothrow;

        alias __timer_t = void*;
        /// Internal rcl publisher implementation struct.
        alias rcl_publisher_impl_t = rcl_publisher_impl_s;
        struct rcl_publisher_impl_s;
        /// Structure which encapsulates a ROS Publisher.
        alias rcl_publisher_t = rcl_publisher_s;
        /// Structure which encapsulates a ROS Publisher.
        struct rcl_publisher_s
        {
            /// Pointer to the publisher implementation
            rcl_publisher_impl_s* impl;
        }
        /// Options available for a rcl publisher.
        alias rcl_publisher_options_t = rcl_publisher_options_s;
        /// Options available for a rcl publisher.
        struct rcl_publisher_options_s
        {
            ...
            rmw_publisher_options_s rmw_publisher_options;
        }
 ...
 * rcl_publisher_init().
 */
        rcl_publisher_s rcl_get_zero_initialized_publisher() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publisher_init(rcl_publisher_s*, const(rcl_node_s)*,
                const(rosidl_message_type_support_t)*, const(char)*,
                const(rcl_publisher_options_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publisher_fini(rcl_publisher_s*, rcl_node_s*) @nogc nothrow;
 ...
 */
        rcl_publisher_options_s rcl_publisher_get_default_options() @nogc nothrow;
 ...
 */
        int rcl_borrow_loaned_message(const(rcl_publisher_s)*,
 ...
 */
        int rcl_return_loaned_message_from_publisher(const(rcl_publisher_s)*, void*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publish(const(rcl_publisher_s)*, const(void)*, rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publish_serialized_message(const(rcl_publisher_s)*,
                const(rcutils_uint8_array_s)*, rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publish_loaned_message(const(rcl_publisher_s)*, void*,
                rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publisher_assert_liveliness(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 */
        int rcl_publisher_wait_for_all_acked(const(rcl_publisher_s)*, c_long) @nogc nothrow;
 ...
 * \return name string if successful, otherwise `NULL`
 */
        const(char)* rcl_publisher_get_topic_name(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 * \return options struct if successful, otherwise `NULL`
 */
        const(rcl_publisher_options_s)* rcl_publisher_get_options(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 */
        rmw_publisher_s* rcl_publisher_get_rmw_handle(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 */
        rcl_context_s* rcl_publisher_get_context(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 */
        bool rcl_publisher_is_valid(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 */
        bool rcl_publisher_is_valid_except_context(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_publisher_get_subscription_count(const(rcl_publisher_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return qos struct if successful, otherwise `NULL`
 */
        const(rmw_qos_profile_s)* rcl_publisher_get_actual_qos(const(rcl_publisher_s)*) @nogc nothrow;
 ...
 */
        bool rcl_publisher_can_loan_messages(const(rcl_publisher_s)*) @nogc nothrow;

        alias __clockid_t = int;
        /// Internal rcl implementation struct.
        alias rcl_service_impl_t = rcl_service_impl_s;
        struct rcl_service_impl_s;
        /// Structure which encapsulates a ROS Service.
        alias rcl_service_t = rcl_service_s;
        /// Structure which encapsulates a ROS Service.
        struct rcl_service_s
        {
            /// Pointer to the service implementation
            rcl_service_impl_s* impl;
        }
        /// Options available for a rcl service.
        alias rcl_service_options_t = rcl_service_options_s;
        /// Options available for a rcl service.
 ...
 */
        rcl_service_s rcl_get_zero_initialized_service() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_service_init(rcl_service_s*, const(rcl_node_s)*,
                const(rosidl_service_type_support_t)*, const(char)*,
                const(rcl_service_options_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_service_fini(rcl_service_s*, rcl_node_s*) @nogc nothrow;
 ...
 * - allocator = rcl_get_default_allocator()
 */
        rcl_service_options_s rcl_service_get_default_options() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_take_request_with_info(const(rcl_service_s)*, rmw_service_info_s*, void*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_take_request(const(rcl_service_s)*, rmw_request_id_s*, void*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_send_response(const(rcl_service_s)*, rmw_request_id_s*, void*) @nogc nothrow;
 ...
 * \return name string if successful, otherwise `NULL`
 */
        const(char)* rcl_service_get_service_name(const(rcl_service_s)*) @nogc nothrow;
 ...
 * \return options struct if successful, otherwise `NULL`
 */
        const(rcl_service_options_s)* rcl_service_get_options(const(rcl_service_s)*) @nogc nothrow;
 ...
 */
        rmw_service_s* rcl_service_get_rmw_handle(const(rcl_service_s)*) @nogc nothrow;
 ...
 */
        bool rcl_service_is_valid(const(rcl_service_s)*) @nogc nothrow;
 ...
 * \return qos struct if successful, otherwise `NULL`
 */
        const(rmw_qos_profile_s)* rcl_service_request_subscription_get_actual_qos(
                const(rcl_service_s)*) @nogc nothrow;
 ...
 * \return qos struct if successful, otherwise `NULL`
 */
        const(rmw_qos_profile_s)* rcl_service_response_publisher_get_actual_qos(
                const(rcl_service_s)*) @nogc nothrow;
 ...
 * \return `RCL_RET_UNSUPPORTED` if the API is not implemented in the dds implementation
 */
        int rcl_service_set_on_new_request_callback(const(rcl_service_s)*,
                void function(const(void)*, c_ulong), const(void)*) @nogc nothrow;
        /// Internal rcl implementation struct.
        alias rcl_subscription_impl_t = rcl_subscription_impl_s;
        struct rcl_subscription_impl_s;
        /// Structure which encapsulates a ROS Subscription.
        alias rcl_subscription_t = rcl_subscription_s;
        /// Structure which encapsulates a ROS Subscription.
        struct rcl_subscription_s
        {
            /// Pointer to the subscription implementation
            rcl_subscription_impl_s* impl;
        }
        /// Options available for a rcl subscription.
        alias rcl_subscription_options_t = rcl_subscription_options_s;
        /// Options available for a rcl subscription.
        struct rcl_subscription_options_s
        {
            ...
            rmw_subscription_options_s rmw_subscription_options;
        }

        alias rcl_subscription_content_filter_options_t = rcl_subscription_content_filter_options_s;

        struct rcl_subscription_content_filter_options_s
        {

            rmw_subscription_content_filter_options_s rmw_subscription_content_filter_options;
        }
 ...
 */
        rcl_subscription_s rcl_get_zero_initialized_subscription() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_subscription_init(rcl_subscription_s*, const(rcl_node_s)*,
                const(rosidl_message_type_support_t)*, const(char)*,
                const(rcl_subscription_options_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_subscription_fini(rcl_subscription_s*, rcl_node_s*) @nogc nothrow;
 ...
 */
        rcl_subscription_options_s rcl_subscription_get_default_options() @nogc nothrow;
 ...
 */
        int rcl_subscription_options_fini(rcl_subscription_options_s*) @nogc nothrow;
 ...
 */
        int rcl_subscription_options_set_content_filter_options(const(char)*,
                c_ulong, const(char)**, rcl_subscription_options_s*) @nogc nothrow;
        /// Return the zero initialized subscription content filter options.
        rcl_subscription_content_filter_options_s rcl_get_zero_initialized_subscription_content_filter_options() @nogc nothrow;
 ...
 * \return `RCL_RET_BAD_ALLOC` if allocating memory fails.
 */
        int rcl_subscription_content_filter_options_init(const(rcl_subscription_s)*, const(char)*,
                c_ulong, const(char)**, rcl_subscription_content_filter_options_s*) @nogc nothrow;
        /// Set the content filter options for the given subscription options.
        /**
 * <hr>
 * Attribute          | Adherence
 ...
 * \return `RCL_RET_BAD_ALLOC` if allocating memory fails.
 */
        int rcl_subscription_content_filter_options_set(const(rcl_subscription_s)*, const(char)*,
                c_ulong, const(char)**, rcl_subscription_content_filter_options_s*) @nogc nothrow;
 ...
 */
        int rcl_subscription_content_filter_options_fini(const(rcl_subscription_s)*,
                rcl_subscription_content_filter_options_s*) @nogc nothrow;
 ...
 */
        bool rcl_subscription_is_cft_enabled(const(rcl_subscription_s)*) @nogc nothrow;
 ...
 * \return `RCL_RET_ERROR` if an unspecified error occurs.
 */
        int rcl_subscription_set_content_filter(const(rcl_subscription_s)*,
                const(rcl_subscription_content_filter_options_s)*) @nogc nothrow;
 ...
 * \return `RCL_RET_ERROR` if an unspecified error occurs.
 */
        int rcl_subscription_get_content_filter(const(rcl_subscription_s)*,
                rcl_subscription_content_filter_options_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_take(const(rcl_subscription_s)*, void*, rmw_message_info_s*,
                rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_take_sequence(const(rcl_subscription_s)*, c_ulong, rmw_message_sequence_s*,
                rmw_message_info_sequence_s*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_take_serialized_message(const(rcl_subscription_s)*,
                rcutils_uint8_array_s*, rmw_message_info_s*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_take_loaned_message(const(rcl_subscription_s)*, void**,
                rmw_message_info_s*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_return_loaned_message_from_subscription(const(rcl_subscription_s)*, void*) @nogc nothrow;
 ...
 * \return name string if successful, otherwise `NULL`
 */
        const(char)* rcl_subscription_get_topic_name(const(rcl_subscription_s)*) @nogc nothrow;
 ...
 * \return options struct if successful, otherwise `NULL`
 */
        const(rcl_subscription_options_s)* rcl_subscription_get_options(const(rcl_subscription_s)*) @nogc nothrow;
 ...
 */
        rmw_subscription_s* rcl_subscription_get_rmw_handle(const(rcl_subscription_s)*) @nogc nothrow;
 ...
 */
        bool rcl_subscription_is_valid(const(rcl_subscription_s)*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_subscription_get_publisher_count(const(rcl_subscription_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return qos struct if successful, otherwise `NULL`
 */
        const(rmw_qos_profile_s)* rcl_subscription_get_actual_qos(const(rcl_subscription_s)*) @nogc nothrow;
 ...
 */
        bool rcl_subscription_can_loan_messages(const(rcl_subscription_s)*) @nogc nothrow;
 ...
 * \return `RCL_RET_UNSUPPORTED` if the API is not implemented in the dds implementation
 */
        int rcl_subscription_set_on_new_message_callback(const(rcl_subscription_s)*,
                void function(const(void)*, c_ulong), const(void)*) @nogc nothrow;
 ...
 */
        alias rcl_clock_type_t = rcl_clock_type_e;
        /// Time source type, used to indicate the source of a time measurement.
        /**
 * RCL_ROS_TIME will report the latest value reported by a ROS time source, or
 * if a ROS time source is not active it reports the same as RCL_SYSTEM_TIME.
 ...
 */
        ...
        enum RCL_CLOCK_UNINITIALIZED = rcl_clock_type_e.RCL_CLOCK_UNINITIALIZED;
        enum RCL_ROS_TIME = rcl_clock_type_e.RCL_ROS_TIME;
        enum RCL_SYSTEM_TIME = rcl_clock_type_e.RCL_SYSTEM_TIME;
        enum RCL_STEADY_TIME = rcl_clock_type_e.RCL_STEADY_TIME;
        /// A duration of time, measured in nanoseconds and its source.
        alias rcl_duration_t = rcl_duration_s;
        /// A duration of time, measured in nanoseconds and its source.
        ...
        alias rcl_clock_change_t = rcl_clock_change_e;
        /// Enumeration to describe the type of time jump.
        ...
        enum RCL_ROS_TIME_NO_CHANGE = rcl_clock_change_e.RCL_ROS_TIME_NO_CHANGE;
        enum RCL_ROS_TIME_ACTIVATED = rcl_clock_change_e.RCL_ROS_TIME_ACTIVATED;
        enum RCL_ROS_TIME_DEACTIVATED = rcl_clock_change_e.RCL_ROS_TIME_DEACTIVATED;
        enum RCL_SYSTEM_TIME_NO_CHANGE = rcl_clock_change_e.RCL_SYSTEM_TIME_NO_CHANGE;
        /// Struct to describe a jump in time.
        alias rcl_time_jump_t = rcl_time_jump_s;
        /// Struct to describe a jump in time.
        struct rcl_time_jump_s
        {
            /// Indicate whether or not the source of time changed.
            rcl_clock_change_e clock_change;
            /// The new time minus the last time before the jump.
            rcl_duration_s delta;
        }

        alias rcl_jump_callback_t = void function(const(rcl_time_jump_s)*, bool, void*);
        /// Describe the prerequisites for calling a time jump callback.
        alias rcl_jump_threshold_t = rcl_jump_threshold_s;
        /// Describe the prerequisites for calling a time jump callback.
        ...
        alias rcl_time_point_t = rcl_time_point_s;
        /// A single point in time, measured in nanoseconds, the reference point is based on the source.
 ...
 */
        bool rcl_clock_valid(rcl_clock_s*) @nogc nothrow;
 ...
 */
        int rcl_clock_init(rcl_clock_type_e, rcl_clock_s*, rcutils_allocator_s*) @nogc nothrow;
        /// Finalize a clock.
        /**
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_clock_fini(rcl_clock_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_ros_clock_init(rcl_clock_s*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_ros_clock_fini(rcl_clock_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_steady_clock_init(rcl_clock_s*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_steady_clock_fini(rcl_clock_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_system_clock_init(rcl_clock_s*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_system_clock_fini(rcl_clock_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_difference_times(const(rcl_time_point_s)*,
                const(rcl_time_point_s)*, rcl_duration_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_clock_get_now(rcl_clock_s*, c_long*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_enable_ros_time_override(rcl_clock_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_disable_ros_time_override(rcl_clock_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_is_enabled_ros_time_override(rcl_clock_s*, bool*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_set_ros_time_override(rcl_clock_s*, c_long) @nogc nothrow;
 ...
 */
        int rcl_clock_add_jump_callback(rcl_clock_s*, rcl_jump_threshold_s,
                void function(const(rcl_time_jump_s)*, bool, void*), void*) @nogc nothrow;
 ...
 */
        int rcl_clock_remove_jump_callback(rcl_clock_s*,
                void function(const(rcl_time_jump_s)*, bool, void*), void*) @nogc nothrow;

        alias __suseconds64_t = c_long;

        alias rcl_timer_impl_t = rcl_timer_impl_s;
        struct rcl_timer_impl_s;
        /// Structure which encapsulates a ROS Timer.
        alias rcl_timer_t = rcl_timer_s;
        /// Structure which encapsulates a ROS Timer.
        struct rcl_timer_s
        {
            /// Private implementation pointer.
            rcl_timer_impl_s* impl;
        }

        alias rcl_timer_callback_t = void function(rcl_timer_s*, c_long);
        /// Return a zero initialized timer.
        rcl_timer_s rcl_get_zero_initialized_timer() @nogc nothrow;
        /// Initialize a timer.
        /**
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_init(rcl_timer_s*, rcl_clock_s*, rcl_context_s*, c_long,
                const(void function(rcl_timer_s*, c_long)), rcutils_allocator_s) @nogc nothrow;
        /// Finalize a timer.
        /**
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_fini(rcl_timer_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_call(rcl_timer_s*) @nogc nothrow;
 ...
 */
        int rcl_timer_clock(rcl_timer_s*, rcl_clock_s**) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_is_ready(const(rcl_timer_s)*, bool*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_get_time_until_next_call(const(rcl_timer_s)*, c_long*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_get_time_since_last_call(const(rcl_timer_s)*, c_long*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_get_period(const(rcl_timer_s)*, c_long*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_exchange_period(const(rcl_timer_s)*, c_long, c_long*) @nogc nothrow;
 ...
 */
        void function(rcl_timer_s*, c_long) rcl_timer_get_callback(const(rcl_timer_s)*) @nogc nothrow;
 ...
 */
        void function(rcl_timer_s*, c_long) rcl_timer_exchange_callback(rcl_timer_s*,
                const(void function(rcl_timer_s*, c_long))) @nogc nothrow;
        /// Cancel a timer.
        /**
 ...
 * \return #RCL_RET_TIMER_INVALID if the timer is invalid.
 */
        int rcl_timer_cancel(rcl_timer_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_is_canceled(const(rcl_timer_s)*, bool*) @nogc nothrow;
        /// Reset a timer.
        /**
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_timer_reset(rcl_timer_s*) @nogc nothrow;
 ...
 */
        const(rcutils_allocator_s)* rcl_timer_get_allocator(const(rcl_timer_s)*) @nogc nothrow;
 ...
 */
        rcl_guard_condition_s* rcl_timer_get_guard_condition(const(rcl_timer_s)*) @nogc nothrow;
        ...
        alias rcl_serialized_message_t = rcutils_uint8_array_s;
        ...
        alias rcl_wait_set_impl_t = rcl_wait_set_impl_s;
        struct rcl_wait_set_impl_s;
        /// Container for subscription's, guard condition's, etc to be waited on.
        alias rcl_wait_set_t = rcl_wait_set_s;
        /// Container for subscription's, guard condition's, etc to be waited on.
        struct rcl_wait_set_s
        {
            /// Storage for subscription pointers.
            const(rcl_subscription_s)** subscriptions;
            /// Number of subscriptions
            c_ulong size_of_subscriptions;
            /// Storage for guard condition pointers.
            const(rcl_guard_condition_s)** guard_conditions;
            /// Number of guard_conditions
            c_ulong size_of_guard_conditions;
            /// Storage for timer pointers.
            const(rcl_timer_s)** timers;
            /// Number of timers
            c_ulong size_of_timers;
            /// Storage for client pointers.
            const(rcl_client_s)** clients;
            /// Number of clients
            c_ulong size_of_clients;
            /// Storage for service pointers.
            const(rcl_service_s)** services;
            /// Number of services
            c_ulong size_of_services;
            /// Storage for event pointers.
            const(rcl_event_s)** events;
            /// Number of events
            c_ulong size_of_events;
            /// Implementation specific storage.
            rcl_wait_set_impl_s* impl;
        }
        /// Return a rcl_wait_set_t struct with members set to `NULL`.
        rcl_wait_set_s rcl_get_zero_initialized_wait_set() @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_wait_set_init(rcl_wait_set_s*, c_ulong, c_ulong, c_ulong,
                c_ulong, c_ulong, c_ulong, rcl_context_s*, rcutils_allocator_s) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_wait_set_fini(rcl_wait_set_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_wait_set_get_allocator(const(rcl_wait_set_s)*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_wait_set_add_subscription(rcl_wait_set_s*, const(rcl_subscription_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_wait_set_clear(rcl_wait_set_s*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_wait_set_resize(rcl_wait_set_s*, c_ulong, c_ulong, c_ulong,
 ...
 */
        int rcl_wait_set_add_guard_condition(rcl_wait_set_s*,
                const(rcl_guard_condition_s)*, c_ulong*) @nogc nothrow;
        /// Store a pointer to the timer in the next empty spot in the set.
        /**
 * This function behaves exactly the same as for subscriptions.
 * \see rcl_wait_set_add_subscription
 */
        int rcl_wait_set_add_timer(rcl_wait_set_s*, const(rcl_timer_s)*, c_ulong*) @nogc nothrow;
        /// Store a pointer to the client in the next empty spot in the set.
        /**
 * This function behaves exactly the same as for subscriptions.
 * \see rcl_wait_set_add_subscription
 */
        int rcl_wait_set_add_client(rcl_wait_set_s*, const(rcl_client_s)*, c_ulong*) @nogc nothrow;
        /// Store a pointer to the service in the next empty spot in the set.
        /**
 * This function behaves exactly the same as for subscriptions.
 * \see rcl_wait_set_add_subscription
 */
        int rcl_wait_set_add_service(rcl_wait_set_s*, const(rcl_service_s)*, c_ulong*) @nogc nothrow;
        /// Store a pointer to the event in the next empty spot in the set.
        /**
 * This function behaves exactly the same as for subscriptions.
 * \see rcl_wait_set_add_subscription
 */
        int rcl_wait_set_add_event(rcl_wait_set_s*, const(rcl_event_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCL_RET_ERROR an unspecified error occur.
 */
        int rcl_wait(rcl_wait_set_s*, c_long) @nogc nothrow;
 ...
 */
        bool rcl_wait_set_is_valid(const(rcl_wait_set_s)*) @nogc nothrow;
        ...
        struct rcl_variant_s
        {
            ...
            ///< If array of strings
            rcutils_string_array_s* string_array_value;
        }
 ...
 */
        alias rcutils_allocator_t = rcutils_allocator_s;
        /// Encapsulation of an allocator.
        /**
 * The default allocator uses malloc(), free(), calloc(), and realloc().
 * It can be obtained using rcutils_get_default_allocator().
 ...
 */
        rcutils_allocator_s rcutils_get_zero_initialized_allocator() @nogc nothrow;
 ...
 * Lock-Free          | Yes
 */
        rcutils_allocator_s rcutils_get_default_allocator() @nogc nothrow;
 ...
 */
        bool rcutils_allocator_is_valid(const(rcutils_allocator_s)*) @nogc nothrow;
 ...
 * \param[in] allocator to be used to allocate and deallocate memory
 */
        void* rcutils_reallocf(void*, c_ulong, rcutils_allocator_s*) @nogc nothrow;

        alias __uid_t = uint;

        alias __dev_t = c_ulong;
        /// Struct wrapping a fixed-size c string used for returning the formatted error string.
        alias rcutils_error_string_t = rcutils_error_string_s;
        /// Struct wrapping a fixed-size c string used for returning the formatted error string.
        ...
        alias rcutils_error_state_t = rcutils_error_state_s;
        /// Struct which encapsulates the error state set by RCUTILS_SET_ERROR_MSG().
 ...
 */
        int rcutils_initialize_error_handling_thread_local_storage(rcutils_allocator_s) @nogc nothrow;
 ...
 */
        const(rcutils_error_state_s)* rcutils_get_error_state() @nogc nothrow;
 ...
 */
        rcutils_error_string_s rcutils_get_error_string() @nogc nothrow;
 ...
 */
        int rcutils_logging_initialize_with_allocator(rcutils_allocator_s) @nogc nothrow;
 ...
 */
        ...
        alias rcutils_log_location_t = rcutils_log_location_s;
        /// The structure identifying the caller location in the source code.
 ...
 */
        int rcutils_logging_severity_level_from_string(const(char)*, rcutils_allocator_s, int*) @nogc nothrow;
        alias rcutils_logging_output_handler_t = void function(const(rcutils_log_location_s)*,
                int, const(char)*, c_long, const(char)*, va_list**);
        /// The function pointer of the current output handler.
        extern __gshared void function(const(rcutils_log_location_s)*, int,
 ...
 */
        void function(const(rcutils_log_location_s)*, int, const(char)*,
 ...
 */
        void rcutils_logging_set_output_handler(void function(const(rcutils_log_location_s)*,
 ...
 */
        int rcutils_logging_format_message(const(rcutils_log_location_s)*,
                int, const(char)*, c_long, const(char)*, rcutils_char_array_s*) @nogc nothrow;
 ...
 */
        void rcutils_log(const(rcutils_log_location_s)*, int, const(char)*, const(char)*, ...) @nogc nothrow;
 ...
 */
        void rcutils_logging_console_output_handler(const(rcutils_log_location_s)*,
                int, const(char)*, c_long, const(char)*, va_list**) @nogc nothrow;
 ...
 */
        ...
        alias rcutils_array_list_t = rcutils_array_list_s;
        /// The structure holding the metadata for an array list.
        struct rcutils_array_list_s
        {
            /// A pointer to the PIMPL implementation type.
            rcutils_array_list_impl_s* impl;
        }
 ...
 * ```
 */
        rcutils_array_list_s rcutils_get_zero_initialized_array_list() @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_array_list_init(rcutils_array_list_s*, c_ulong, c_ulong,
                const(rcutils_allocator_s)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_array_list_fini(rcutils_array_list_s*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_array_list_add(rcutils_array_list_s*, const(void)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_array_list_set(rcutils_array_list_s*, c_ulong, const(void)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_array_list_remove(rcutils_array_list_s*, c_ulong) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_array_list_get(const(rcutils_array_list_s)*, c_ulong, void*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_array_list_get_size(const(rcutils_array_list_s)*, c_ulong*) @nogc nothrow;
        /// The structure holding the metadata for a char array.
        alias rcutils_char_array_t = rcutils_char_array_s;
        /// The structure holding the metadata for a char array.
 ...
 */
        rcutils_char_array_s rcutils_get_zero_initialized_char_array() @nogc nothrow;
 ...
 */
        int rcutils_char_array_init(rcutils_char_array_s*, c_ulong, const(rcutils_allocator_s)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_fini(rcutils_char_array_s*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_resize(rcutils_char_array_s*, c_ulong) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_expand_as_needed(rcutils_char_array_s*, c_ulong) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_vsprintf(rcutils_char_array_s*, const(char)*, va_list*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_strncat(rcutils_char_array_s*, const(char)*, c_ulong) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_strcat(rcutils_char_array_s*, const(char)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_memcpy(rcutils_char_array_s*, const(char)*, c_ulong) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_char_array_strcpy(rcutils_char_array_s*, const(char)*) @nogc nothrow;
        struct rcutils_hash_map_impl_s;
        /// The structure holding the metadata for a hash map.
        alias rcutils_hash_map_t = rcutils_hash_map_s;
        /// The structure holding the metadata for a hash map.
        struct rcutils_hash_map_s
        {
            /// A pointer to the PIMPL implementation type.
            rcutils_hash_map_impl_s* impl;
        }
 ...
 * ```
 * */
        rcutils_hash_map_s rcutils_get_zero_initialized_hash_map() @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_init(rcutils_hash_map_s*, c_ulong, c_ulong, c_ulong,
                c_ulong function(const(void)*), int function(const(void)*,
                    const(void)*), const(rcutils_allocator_s)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_fini(rcutils_hash_map_s*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_get_capacity(const(rcutils_hash_map_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_get_size(const(rcutils_hash_map_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_set(rcutils_hash_map_s*, const(void)*, const(void)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_unset(rcutils_hash_map_s*, const(void)*) @nogc nothrow;
 ...
 */
        bool rcutils_hash_map_key_exists(const(rcutils_hash_map_s)*, const(void)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_get(const(rcutils_hash_map_s)*, const(void)*, void*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_hash_map_get_next_key_and_data(const(rcutils_hash_map_s)*,
        ...
        alias rcutils_string_array_t = rcutils_string_array_s;
        /// The structure holding the metadata for a string array.
 ...
 * ```
 */
        rcutils_string_array_s rcutils_get_zero_initialized_string_array() @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_array_init(rcutils_string_array_s*, c_ulong,
                const(rcutils_allocator_s)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_array_fini(rcutils_string_array_s*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_array_cmp(const(rcutils_string_array_s)*,
                const(rcutils_string_array_s)*, int*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_array_resize(rcutils_string_array_s*, c_ulong) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_array_sort(rcutils_string_array_s*) @nogc nothrow;

        alias uint64_t = ulong;
        struct rcutils_string_map_impl_s;
        /// The structure holding the metadata for a string map.
        alias rcutils_string_map_t = rcutils_string_map_s;
        /// The structure holding the metadata for a string map.
        struct rcutils_string_map_s
        {
            /// A pointer to the PIMPL implementation type.
            rcutils_string_map_impl_s* impl;
        }
 ...
 * ```
 * */
        rcutils_string_map_s rcutils_get_zero_initialized_string_map() @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_init(rcutils_string_map_s*, c_ulong, rcutils_allocator_s) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_fini(rcutils_string_map_s*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_get_capacity(const(rcutils_string_map_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_get_size(const(rcutils_string_map_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_reserve(rcutils_string_map_s*, c_ulong) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_clear(rcutils_string_map_s*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_set(rcutils_string_map_s*, const(char)*, const(char)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_set_no_resize(rcutils_string_map_s*, const(char)*, const(char)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_unset(rcutils_string_map_s*, const(char)*) @nogc nothrow;
        /// Get whether or not a key exists.
        /**
 * The key needs to be a null terminated c string.
 *
 ...
 */
        bool rcutils_string_map_key_exists(const(rcutils_string_map_s)*, const(char)*) @nogc nothrow;
 ...
 * \return `false` if the string map is invalid.
 */
        bool rcutils_string_map_key_existsn(const(rcutils_string_map_s)*, const(char)*, c_ulong) @nogc nothrow;
        /// Get value given a key.
        /**
 * The key needs to be a null terminated c string.
 *
 ...
 */
        const(char)* rcutils_string_map_get(const(rcutils_string_map_s)*, const(char)*) @nogc nothrow;
 ...
 * \return `NULL` if an unknown error occurs.
 */
        const(char)* rcutils_string_map_getn(const(rcutils_string_map_s)*, const(char)*, c_ulong) @nogc nothrow;
 ...
 * \return `NULL` if an unknown error occurs.
 */
        const(char)* rcutils_string_map_get_next_key(const(rcutils_string_map_s)*, const(char)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unknown error occurs.
 */
        int rcutils_string_map_copy(const(rcutils_string_map_s)*, rcutils_string_map_s*) @nogc nothrow;

        alias uint32_t = uint;
        /// The structure holding the metadata for a uint8 array.
        alias rcutils_uint8_array_t = rcutils_uint8_array_s;
        /// The structure holding the metadata for a uint8 array.
 ...
 */
        rcutils_uint8_array_s rcutils_get_zero_initialized_uint8_array() @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_uint8_array_init(rcutils_uint8_array_s*, c_ulong,
                const(rcutils_allocator_s)*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_uint8_array_fini(rcutils_uint8_array_s*) @nogc nothrow;
 ...
 * \return #RCUTILS_RET_ERROR if an unexpected error occurs.
 */
        int rcutils_uint8_array_resize(rcutils_uint8_array_s*, c_ulong) @nogc nothrow;
        ...
        alias rmw_event_type_t = rmw_event_type_e;
        /// Define publisher/subscription events
        ...
        enum RMW_EVENT_LIVELINESS_CHANGED = rmw_event_type_e.RMW_EVENT_LIVELINESS_CHANGED;
        enum RMW_EVENT_REQUESTED_DEADLINE_MISSED = rmw_event_type_e
                .RMW_EVENT_REQUESTED_DEADLINE_MISSED;
        enum RMW_EVENT_REQUESTED_QOS_INCOMPATIBLE = rmw_event_type_e
                .RMW_EVENT_REQUESTED_QOS_INCOMPATIBLE;
        enum RMW_EVENT_MESSAGE_LOST = rmw_event_type_e.RMW_EVENT_MESSAGE_LOST;
        enum RMW_EVENT_LIVELINESS_LOST = rmw_event_type_e.RMW_EVENT_LIVELINESS_LOST;
        enum RMW_EVENT_OFFERED_DEADLINE_MISSED = rmw_event_type_e.RMW_EVENT_OFFERED_DEADLINE_MISSED;
        enum RMW_EVENT_OFFERED_QOS_INCOMPATIBLE = rmw_event_type_e
                .RMW_EVENT_OFFERED_QOS_INCOMPATIBLE;
        enum RMW_EVENT_INVALID = rmw_event_type_e.RMW_EVENT_INVALID;
        /// Encapsulate the RMW event implementation, data, and type.
        alias rmw_event_t = rmw_event_s;
        /// Encapsulate the RMW event implementation, data, and type.
        struct rmw_event_s
        {
            ...
            rmw_event_type_e event_type;
        }
        /// Return a zero initialized event structure.
        rmw_event_s rmw_get_zero_initialized_event() @nogc nothrow;
 ...
 */
        int rmw_publisher_event_init(rmw_event_s*, const(rmw_publisher_s)*, rmw_event_type_e) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_subscription_event_init(rmw_event_s*,
                const(rmw_subscription_s)*, rmw_event_type_e) @nogc nothrow;
        /// Take an event from the event handle.
        /**
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_event(const(rmw_event_s)*, void*, bool*) @nogc nothrow;
        /// Finalize an rmw_event_t.
        /**
 * \param[in] event to finalize
 */
        int rmw_event_fini(rmw_event_s*) @nogc nothrow;
        alias rmw_event_callback_t = void function(const(void)*, c_ulong);
        ...
        alias rmw_qos_incompatible_event_status_t = rmw_qos_incompatible_event_status_s;
   ...
   */
            rmw_qos_policy_kind_e last_policy_kind;
        }
        /// Event state for a subscription's 'RMW_EVENT_REQUESTED_QOS_INCOMPATIBLE' events.
        alias rmw_requested_qos_incompatible_event_status_t = rmw_qos_incompatible_event_status_s;
        /// Event state for a publisher's 'RMW_EVENT_OFFERED_QOS_INCOMPATIBLE' events.
        alias rmw_offered_qos_incompatible_event_status_t = rmw_qos_incompatible_event_status_s;
        /// QoS Liveliness Changed information provided by a subscription.
        alias rmw_liveliness_changed_status_t = rmw_liveliness_changed_status_s;
        /// QoS Liveliness Changed information provided by a subscription.
   ...
   */
        ...
        alias rmw_liveliness_lost_status_t = rmw_liveliness_lost_status_s;
        /// QoS Liveliness Lost information provided by a publisher.
   ...
   */
        ...
        alias rmw_message_lost_status_t = rmw_message_lost_status_s;
        ...
        struct rmw_message_lost_status_s
        {
            ...
            c_ulong total_count_change;
        }
        /// QoS Deadline Missed information provided by a publisher.
        alias rmw_offered_deadline_missed_status_t = rmw_offered_deadline_missed_status_s;
        /// QoS Deadline Missed information provided by a publisher.
   ...
   */
        ...
        alias rmw_requested_deadline_missed_status_t = rmw_requested_deadline_missed_status_s;
        /// QoS Requested Deadline Missed information provided by a subscription.
 ...
 */
        int rmw_get_topic_names_and_types(const(rmw_node_s)*,
                rcutils_allocator_s*, bool, rmw_names_and_types_s*) @nogc nothrow;
 ...
 */
        alias rmw_context_impl_t = rmw_context_impl_s;
        struct rmw_context_impl_s;
        /// Initialization context structure which is used to store init specific information.
        alias rmw_context_t = rmw_context_s;
        /// Initialization context structure which is used to store init specific information.
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_init(const(rmw_init_options_s)*, rmw_context_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_shutdown(rmw_context_s*) @nogc nothrow;
        /// Finalize a context.
        /**
 ...
 */
        int rmw_context_fini(rmw_context_s*) @nogc nothrow;
        /// Implementation defined options structure used during rmw_init().
        /**
 * This should be defined by the rmw implementation.
 */
        alias rmw_init_options_impl_t = rmw_init_options_impl_s;
        struct rmw_init_options_impl_s;
        /// Options structure used during rmw_init().
        alias rmw_init_options_t = rmw_init_options_s;
        /// Options structure used during rmw_init().
   ...
   */
            ...
            c_ulong domain_id;
            /// Security options
            rmw_security_options_s security_options;
            /// Enable localhost only
            rmw_localhost_only_e localhost_only;
            ...
            rmw_init_options_impl_s* impl;
        }
        /// Return a zero initialized init options structure.
        rmw_init_options_s rmw_get_zero_initialized_init_options() @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_init_options_init(rmw_init_options_s*, rcutils_allocator_s) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_init_options_copy(const(rmw_init_options_s)*, rmw_init_options_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_init_options_fini(rmw_init_options_s*) @nogc nothrow;
        /// Used to specify if the context can only communicate through localhost.
        alias rmw_localhost_only_t = rmw_localhost_only_e;
        /// Used to specify if the context can only communicate through localhost.
        ...
        enum RMW_LOCALHOST_ONLY_DEFAULT = rmw_localhost_only_e.RMW_LOCALHOST_ONLY_DEFAULT;
        enum RMW_LOCALHOST_ONLY_ENABLED = rmw_localhost_only_e.RMW_LOCALHOST_ONLY_ENABLED;
        enum RMW_LOCALHOST_ONLY_DISABLED = rmw_localhost_only_e.RMW_LOCALHOST_ONLY_DISABLED;
        ...
        alias rmw_message_sequence_t = rmw_message_sequence_s;
        /// Structure to hold a sequence of ROS messages.
        ...
        alias rmw_message_info_sequence_t = rmw_message_info_sequence_s;
        /// Structure to hold a sequence of message infos.
        struct rmw_message_info_sequence_s
        {
            /// Array of message info.
            rmw_message_info_s* data;
            /// The number of valid entries in data.
            c_ulong size;
            /// The total allocated capacity of the data array.
            c_ulong capacity;
        ...
        rmw_message_sequence_s rmw_get_zero_initialized_message_sequence() @nogc nothrow;
 ...
 */
        int rmw_message_sequence_init(rmw_message_sequence_s*, c_ulong, rcutils_allocator_s*) @nogc nothrow;
 ...
 */
        int rmw_message_sequence_fini(rmw_message_sequence_s*) @nogc nothrow;
        /// Return an rmw_message_info_sequence_t struct with members initialized to `NULL`
        rmw_message_info_sequence_s rmw_get_zero_initialized_message_info_sequence() @nogc nothrow;
 ...
 * \param[in] allocator the allcator used to allocate memory.
 */
        int rmw_message_info_sequence_init(rmw_message_info_sequence_s*,
                c_ulong, rcutils_allocator_s*) @nogc nothrow;
        /// Finalize an rmw_message_sequence_t object.
        /**
 * The rmw_message_sequence_t struct has members which require memory to be allocated to them
 * before setting values.
 ...
 * \param[inout] sequence sequence object to be finalized.
 */
        int rmw_message_info_sequence_fini(rmw_message_info_sequence_s*) @nogc nothrow;
        ...
        alias rmw_names_and_types_t = rmw_names_and_types_s;
        /// Associative array of topic or service names and types.
        struct rmw_names_and_types_s
        {
            /// Array of names
            rcutils_string_array_s names;
            /// Dynamic array of arrays of type names, with the same length as `names`
            rcutils_string_array_s* types;
        }
        /// Return a zero initialized array of names and types.
        rmw_names_and_types_s rmw_get_zero_initialized_names_and_types() @nogc nothrow;
 ...
 */
        int rmw_names_and_types_check_zero(rmw_names_and_types_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_names_and_types_init(rmw_names_and_types_s*, c_ulong, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_names_and_types_fini(rmw_names_and_types_s*) @nogc nothrow;
        /// Return a rmw_publisher_options_t initialized with default values.
        rmw_publisher_options_s rmw_get_default_publisher_options() @nogc nothrow;
        /// QoS Policy Kinds
        alias rmw_qos_policy_kind_t = rmw_qos_policy_kind_e;
        /// QoS Policy Kinds
        ...
        enum RMW_QOS_POLICY_INVALID = rmw_qos_policy_kind_e.RMW_QOS_POLICY_INVALID;
        enum RMW_QOS_POLICY_DURABILITY = rmw_qos_policy_kind_e.RMW_QOS_POLICY_DURABILITY;
        enum RMW_QOS_POLICY_DEADLINE = rmw_qos_policy_kind_e.RMW_QOS_POLICY_DEADLINE;
        enum RMW_QOS_POLICY_LIVELINESS = rmw_qos_policy_kind_e.RMW_QOS_POLICY_LIVELINESS;
        enum RMW_QOS_POLICY_RELIABILITY = rmw_qos_policy_kind_e.RMW_QOS_POLICY_RELIABILITY;
        enum RMW_QOS_POLICY_HISTORY = rmw_qos_policy_kind_e.RMW_QOS_POLICY_HISTORY;
        enum RMW_QOS_POLICY_LIFESPAN = rmw_qos_policy_kind_e.RMW_QOS_POLICY_LIFESPAN;
        enum RMW_QOS_POLICY_DEPTH = rmw_qos_policy_kind_e.RMW_QOS_POLICY_DEPTH;
        enum RMW_QOS_POLICY_LIVELINESS_LEASE_DURATION = rmw_qos_policy_kind_e
                .RMW_QOS_POLICY_LIVELINESS_LEASE_DURATION;
        enum RMW_QOS_POLICY_AVOID_ROS_NAMESPACE_CONVENTIONS = rmw_qos_policy_kind_e
        ...
        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_sensor_data;

        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_parameters;

        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_default;

        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_services_default;

        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_parameter_events;

        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_system_default;
 ...
 */
        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_best_available;

        extern __gshared const(rmw_qos_profile_s) rmw_qos_profile_unknown;

        alias rmw_qos_compatibility_type_t = rmw_qos_compatibility_type_e;
        ...
        enum RMW_QOS_COMPATIBILITY_OK = rmw_qos_compatibility_type_e.RMW_QOS_COMPATIBILITY_OK;
        enum RMW_QOS_COMPATIBILITY_WARNING = rmw_qos_compatibility_type_e
                .RMW_QOS_COMPATIBILITY_WARNING;
        enum RMW_QOS_COMPATIBILITY_ERROR = rmw_qos_compatibility_type_e.RMW_QOS_COMPATIBILITY_ERROR;
 ...
 */
        int rmw_qos_profile_check_compatible(const(rmw_qos_profile_s),
                const(rmw_qos_profile_s), rmw_qos_compatibility_type_e*, char*, c_ulong) @nogc nothrow;
 ...
 */
        rmw_node_s* rmw_create_node(rmw_context_s*, const(char)*, const(char)*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_destroy_node(rmw_node_s*) @nogc nothrow;
        /**
 ...
 */
        int rmw_node_assert_liveliness(const(rmw_node_s)*) @nogc nothrow;
        /// Return a guard condition which is triggered when the ROS graph changes.
        /**
 * The guard condition will be triggered anytime a change to the ROS graph occurs.
 ...
 */
        const(rmw_guard_condition_s)* rmw_node_get_graph_guard_condition(const(rmw_node_s)*) @nogc nothrow;
 ...
 */
        int rmw_init_publisher_allocation(const(rosidl_message_type_support_t)*,
                const(rosidl_runtime_c__Sequence__bound)*, rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_fini_publisher_allocation(rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 */
        rmw_publisher_s* rmw_create_publisher(const(rmw_node_s)*, const(rosidl_message_type_support_t)*,
                const(char)*, const(rmw_qos_profile_s)*, const(rmw_publisher_options_s)*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_destroy_publisher(rmw_node_s*, rmw_publisher_s*) @nogc nothrow;
 ...
 */
        int rmw_borrow_loaned_message(const(rmw_publisher_s)*,
                const(rosidl_message_type_support_t)*, void**) @nogc nothrow;
        /// Return a loaned message previously borrowed from a publisher.
        /**
 ...
 */
        int rmw_return_loaned_message_from_publisher(const(rmw_publisher_s)*, void*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_publish(const(rmw_publisher_s)*, const(void)*, rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_publish_loaned_message(const(rmw_publisher_s)*, void*,
                rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_publisher_count_matched_subscriptions(const(rmw_publisher_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_publisher_get_actual_qos(const(rmw_publisher_s)*, rmw_qos_profile_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_publish_serialized_message(const(rmw_publisher_s)*,
                const(rcutils_uint8_array_s)*, rmw_publisher_allocation_s*) @nogc nothrow;
 ...
 */
        int rmw_publisher_assert_liveliness(const(rmw_publisher_s)*) @nogc nothrow;
        /// Wait until all published message data is acknowledged or until the specified timeout elapses.
        /**
 * This function waits until all published message data were acknowledged by peer node or timeout.
 *
 ...
 */
        int rmw_publisher_wait_for_all_acked(const(rmw_publisher_s)*, rmw_time_s) @nogc nothrow;
 ...
 */
        int rmw_serialize(const(void)*,
                const(rosidl_message_type_support_t)*, rcutils_uint8_array_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_deserialize(const(rcutils_uint8_array_s)*,
                const(rosidl_message_type_support_t)*, void*) @nogc nothrow;
 ...
 */
        int rmw_init_subscription_allocation(const(rosidl_message_type_support_t)*,
                const(rosidl_runtime_c__Sequence__bound)*, rmw_subscription_allocation_s*) @nogc nothrow;
        /// Destroy a publisher allocation object.
        /**
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_fini_subscription_allocation(rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 */
        rmw_subscription_s* rmw_create_subscription(const(rmw_node_s)*, const(rosidl_message_type_support_t)*,
                const(char)*, const(rmw_qos_profile_s)*, const(rmw_subscription_options_s)*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_destroy_subscription(rmw_node_s*, rmw_subscription_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_subscription_count_matched_publishers(const(rmw_subscription_s)*, c_ulong*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_subscription_get_actual_qos(const(rmw_subscription_s)*, rmw_qos_profile_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_subscription_set_content_filter(rmw_subscription_s*,
                const(rmw_subscription_content_filter_options_s)*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_subscription_get_content_filter(const(rmw_subscription_s)*,
                rcutils_allocator_s*, rmw_subscription_content_filter_options_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take(const(rmw_subscription_s)*, void*, bool*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_with_info(const(rmw_subscription_s)*, void*, bool*,
                rmw_message_info_s*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_sequence(const(rmw_subscription_s)*, c_ulong, rmw_message_sequence_s*,
                rmw_message_info_sequence_s*, c_ulong*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_serialized_message(const(rmw_subscription_s)*,
                rcutils_uint8_array_s*, bool*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_serialized_message_with_info(const(rmw_subscription_s)*,
                rcutils_uint8_array_s*, bool*, rmw_message_info_s*,
                rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_loaned_message(const(rmw_subscription_s)*, void**,
                bool*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_loaned_message_with_info(const(rmw_subscription_s)*,
                void**, bool*, rmw_message_info_s*, rmw_subscription_allocation_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_return_loaned_message_from_subscription(const(rmw_subscription_s)*, void*) @nogc nothrow;
 ...
 */
        rmw_client_s* rmw_create_client(const(rmw_node_s)*,
                const(rosidl_service_type_support_t)*, const(char)*, const(rmw_qos_profile_s)*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_destroy_client(rmw_node_s*, rmw_client_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_send_request(const(rmw_client_s)*, const(void)*, c_long*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_response(const(rmw_client_s)*, rmw_service_info_s*, void*, bool*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_client_request_publisher_get_actual_qos(const(rmw_client_s)*, rmw_qos_profile_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_client_response_subscription_get_actual_qos(const(rmw_client_s)*,
                rmw_qos_profile_s*) @nogc nothrow;
 ...
 */
        rmw_service_s* rmw_create_service(const(rmw_node_s)*,
                const(rosidl_service_type_support_t)*, const(char)*, const(rmw_qos_profile_s)*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_destroy_service(rmw_node_s*, rmw_service_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_take_request(const(rmw_service_s)*, rmw_service_info_s*, void*, bool*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_send_response(const(rmw_service_s)*, rmw_request_id_s*, void*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_service_request_subscription_get_actual_qos(const(rmw_service_s)*,
                rmw_qos_profile_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_service_response_publisher_get_actual_qos(const(rmw_service_s)*,
                rmw_qos_profile_s*) @nogc nothrow;
 ...
 */
        rmw_guard_condition_s* rmw_create_guard_condition(rmw_context_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unexpected error occurs.
 */
        int rmw_destroy_guard_condition(rmw_guard_condition_s*) @nogc nothrow;

        int rmw_trigger_guard_condition(const(rmw_guard_condition_s)*) @nogc nothrow;
 ...
 */
        rmw_wait_set_s* rmw_create_wait_set(rmw_context_s*, c_ulong) @nogc nothrow;
        /// Destroy a wait set.
        /**
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_destroy_wait_set(rmw_wait_set_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_wait(rmw_subscriptions_s*, rmw_guard_conditions_s*, rmw_services_s*,
                rmw_clients_s*, rmw_events_s*, rmw_wait_set_s*, const(rmw_time_s)*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_get_node_names(const(rmw_node_s)*, rcutils_string_array_s*,
                rcutils_string_array_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_get_node_names_with_enclaves(const(rmw_node_s)*,
                rcutils_string_array_s*, rcutils_string_array_s*, rcutils_string_array_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_count_publishers(const(rmw_node_s)*, const(char)*, c_ulong*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_count_subscribers(const(rmw_node_s)*, const(char)*, c_ulong*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_get_gid_for_publisher(const(rmw_publisher_s)*, rmw_gid_s*) @nogc nothrow;
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_compare_gids_equal(const(rmw_gid_s)*, const(rmw_gid_s)*, bool*) @nogc nothrow;
        /// Check if a service server is available for the given service client.
        /**
 ...
 * \return `RMW_RET_ERROR` if an unspecified error occurs.
 */
        int rmw_service_server_is_available(const(rmw_node_s)*, const(rmw_client_s)*, bool*) @nogc nothrow;
 ...
 */
        int rmw_subscription_set_on_new_message_callback(rmw_subscription_s*,
                void function(const(void)*, c_ulong), const(void)*) @nogc nothrow;
        /// Set the on new request callback function for the service.
        /**
 * This API sets the callback function to be called whenever the
 ...
 * \return `RMW_RET_UNSUPPORTED` if the API is not implemented in the dds implementation
 */
        int rmw_service_set_on_new_request_callback(rmw_service_s*,
                void function(const(void)*, c_ulong), const(void)*) @nogc nothrow;
        /// Set the on new response callback function for the client.
        /**
 * This API sets the callback function to be called whenever the
 ...
 * \return `RMW_RET_UNSUPPORTED` if the API is not implemented in the dds implementation
 */
        int rmw_client_set_on_new_response_callback(rmw_client_s*,
                void function(const(void)*, c_ulong), const(void)*) @nogc nothrow;
        /// Set the callback function for the event.
        /**
 * This API sets the callback function to be called whenever the
 ...
 * \return `RMW_RET_UNSUPPORTED` if the API is not implemented in the dds implementation
 */
        int rmw_event_set_callback(rmw_event_s*, void function(const(void)*,
                c_ulong), const(void)*) @nogc nothrow;

        alias rmw_security_enforcement_policy_t = rmw_security_enforcement_policy_e;
        ...
        enum RMW_SECURITY_ENFORCEMENT_PERMISSIVE = rmw_security_enforcement_policy_e
                .RMW_SECURITY_ENFORCEMENT_PERMISSIVE;
        enum RMW_SECURITY_ENFORCEMENT_ENFORCE = rmw_security_enforcement_policy_e
                .RMW_SECURITY_ENFORCEMENT_ENFORCE;

        alias rmw_security_options_t = rmw_security_options_s;

        struct rmw_security_options_s
        {

            rmw_security_enforcement_policy_e enforce_security;

            char* security_root_path;
        }
        /// Get zero initialized security options.
        rmw_security_options_s rmw_get_zero_initialized_security_options() @nogc nothrow;
        /// Get default initialized security options.
        rmw_security_options_s rmw_get_default_security_options() @nogc nothrow;
 ...
 * \returns RMW_RET_OK
 */
        int rmw_security_options_copy(const(rmw_security_options_s)*,
                const(rcutils_allocator_s)*, rmw_security_options_s*) @nogc nothrow;
 ...
 * \returns RMW_RET_OK
 */
        int rmw_security_options_fini(rmw_security_options_s*, const(rcutils_allocator_s)*) @nogc nothrow;
 ...
 */
        alias rmw_serialized_message_t = rcutils_uint8_array_s;

        alias pthread_t = c_ulong;

        alias rmw_subscription_content_filter_options_t = rmw_subscription_content_filter_options_s;
   ...
   */
            rcutils_string_array_s expression_parameters;
        }
        /// Get zero initialized content filter options.
        rmw_subscription_content_filter_options_s rmw_get_zero_initialized_content_filter_options() @nogc nothrow;
 ...
 * \returns RMW_RET_OK
 */
        int rmw_subscription_content_filter_options_init(const(char)*, c_ulong, const(char)**,
                const(rcutils_allocator_s)*, rmw_subscription_content_filter_options_s*) @nogc nothrow;
 ...
 * \returns RMW_RET_OK
 */
        int rmw_subscription_content_filter_options_set(const(char)*, c_ulong, const(char)**,
                const(rcutils_allocator_s)*, rmw_subscription_content_filter_options_s*) @nogc nothrow;
 ...
 * \returns RMW_RET_OK
 */
        int rmw_subscription_content_filter_options_copy(const(rmw_subscription_content_filter_options_s)*,
                const(rcutils_allocator_s)*, rmw_subscription_content_filter_options_s*) @nogc nothrow;
 ...
 */
        int rmw_subscription_content_filter_options_fini(
                rmw_subscription_content_filter_options_s*, const(rcutils_allocator_s)*) @nogc nothrow;
        /// Return a rmw_subscription_options_t initialized with default values.
        rmw_subscription_options_s rmw_get_default_subscription_options() @nogc nothrow;
        /// A struct representing a duration or relative time in RMW - does not encode an origin.
        alias rmw_time_t = rmw_time_s;
        /// A struct representing a duration or relative time in RMW - does not encode an origin.
        struct rmw_time_s
        {
            /// Seconds component
  ...
  */
        rmw_time_s rmw_time_from_nsec(const(c_long)) @nogc nothrow;
        /// Ensure that an rmw_time_t does not have nanoseconds > 1 second.
        rmw_time_s rmw_time_normalize(const(rmw_time_s)) @nogc nothrow;
        ...
        /// for a topic.
        alias rmw_topic_endpoint_info_t = rmw_topic_endpoint_info_s;
        /// A data structure that encapsulates the node name, node namespace,
        /// topic_type, gid, and qos_profile of publishers and subscriptions
        /// for a topic.
 ...
 */
        rmw_topic_endpoint_info_s rmw_get_zero_initialized_topic_endpoint_info() @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_fini(rmw_topic_endpoint_info_s*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_set_topic_type(rmw_topic_endpoint_info_s*,
                const(char)*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_set_node_name(rmw_topic_endpoint_info_s*,
                const(char)*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_set_node_namespace(rmw_topic_endpoint_info_s*,
                const(char)*, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_set_endpoint_type(rmw_topic_endpoint_info_s*,
                rmw_endpoint_type_e) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_set_gid(rmw_topic_endpoint_info_s*, const(ubyte)*, c_ulong) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_set_qos_profile(rmw_topic_endpoint_info_s*,
                const(rmw_qos_profile_s)*) @nogc nothrow;
        /// Array of topic endpoint information
        alias rmw_topic_endpoint_info_array_t = rmw_topic_endpoint_info_array_s;
        /// Array of topic endpoint information
        struct rmw_topic_endpoint_info_array_s
        {
            ...
            rmw_topic_endpoint_info_s* info_array;
        }
        /// Return a zero initialized array of topic endpoint information.
        rmw_topic_endpoint_info_array_s rmw_get_zero_initialized_topic_endpoint_info_array() @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_array_check_zero(rmw_topic_endpoint_info_array_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_array_init_with_size(rmw_topic_endpoint_info_array_s*,
                c_ulong, rcutils_allocator_s*) @nogc nothrow;
 ...
 * \remark This function sets the RMW error state on failure.
 */
        int rmw_topic_endpoint_info_array_fini(rmw_topic_endpoint_info_array_s*,
                rcutils_allocator_s*) @nogc nothrow;
        /// Structure which encapsulates an rmw node
        alias rmw_node_t = rmw_node_s;
        /// Structure which encapsulates an rmw node
        struct rmw_node_s
        {
            ...
            rmw_context_s* context;
        }
        /// Endpoint enumeration type
        alias rmw_endpoint_type_t = rmw_endpoint_type_e;
        /// Endpoint enumeration type
        ...
        enum RMW_ENDPOINT_INVALID = rmw_endpoint_type_e.RMW_ENDPOINT_INVALID;
        enum RMW_ENDPOINT_PUBLISHER = rmw_endpoint_type_e.RMW_ENDPOINT_PUBLISHER;
        enum RMW_ENDPOINT_SUBSCRIPTION = rmw_endpoint_type_e.RMW_ENDPOINT_SUBSCRIPTION;
        /// Unique network flow endpoints requirement enumeration
        alias rmw_unique_network_flow_endpoints_requirement_t = rmw_unique_network_flow_endpoints_requirement_e;
        /// Unique network flow endpoints requirement enumeration
        ...
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_NOT_REQUIRED = rmw_unique_network_flow_endpoints_requirement_e
                .RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_NOT_REQUIRED;
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_STRICTLY_REQUIRED = rmw_unique_network_flow_endpoints_requirement_e
                .RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_STRICTLY_REQUIRED;
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_OPTIONALLY_REQUIRED = rmw_unique_network_flow_endpoints_requirement_e
                .RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_OPTIONALLY_REQUIRED;
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_SYSTEM_DEFAULT = rmw_unique_network_flow_endpoints_requirement_e
                .RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_SYSTEM_DEFAULT;
        /// Options that can be used to configure the creation of a publisher in rmw.
        alias rmw_publisher_options_t = rmw_publisher_options_s;
        /// Options that can be used to configure the creation of a publisher in rmw.
   ...
   */
            rmw_unique_network_flow_endpoints_requirement_e require_unique_network_flow_endpoints;
        }
        /// Structure which encapsulates an rmw publisher
        alias rmw_publisher_t = rmw_publisher_s;
        /// Structure which encapsulates an rmw publisher
   ...
   */
            rmw_publisher_options_s options;
        ...
        alias rmw_subscription_options_t = rmw_subscription_options_s;
        /// Options that can be used to configure the creation of a subscription in rmw.
   ...
   */
            ...
            rmw_subscription_content_filter_options_s* content_filter_options;
        }

        alias rmw_subscription_t = rmw_subscription_s;
   ...
   * This field is not marked const to avoid any const casting during setup.
   */
            rmw_subscription_options_s options;
        ...
        alias rmw_service_t = rmw_service_s;
        /// A handle to an rmw service
        ...
        alias rmw_client_t = rmw_client_s;
        /// A handle to an rmw service client
        struct rmw_client_s
        {
            /// The name of the rmw implementation
        ...
        alias rmw_guard_condition_t = rmw_guard_condition_s;
        /// Handle for an rmw guard condition
        ...
        alias rmw_publisher_allocation_t = rmw_publisher_allocation_s;
        /// Allocation of memory for an rmw publisher
        ...
        alias rmw_subscription_allocation_t = rmw_subscription_allocation_s;
        /// Allocation of memory for an rmw subscription
 ...
 */
        alias rmw_subscriptions_t = rmw_subscriptions_s;
        /// Array of subscriber handles.
        /**
 * An array of void * pointers representing type-erased middleware-specific subscriptions.
 * The number of non-null entries may be smaller than the allocated size of the array.
 ...
 * The creator of this struct is responsible for allocating and deallocating the array.
 */
        alias rmw_services_t = rmw_services_s;
        /// Array of service handles.
        /**
 * An array of void * pointers representing type-erased middleware-specific services.
 * The number of non-null entries may be smaller than the allocated size of the array.
 ...
 * The creator of this struct is responsible for allocating and deallocating the array.
 */
        alias rmw_clients_t = rmw_clients_s;
        /// Array of client handles.
        /**
 * An array of void * pointers representing type-erased middleware-specific clients.
 * The number of non-null entries may be smaller than the allocated size of the array.
 ...
 */
        ...
        alias rmw_events_t = rmw_events_s;
 ...
 * The creator of this struct is responsible for allocating and deallocating the array.
 */
        alias rmw_guard_conditions_t = rmw_guard_conditions_s;
        /// Array of guard condition handles.
        /**
 * An array of void * pointers representing type-erased middleware-specific guard conditions.
 * The number of non-null entries may be smaller than the allocated size of the array.
 ...
 */
        ...
        alias rmw_wait_set_t = rmw_wait_set_s;
        /// Container for guard conditions to be waited on
        struct rmw_wait_set_s
        {
            ...
            rmw_guard_conditions_s* guard_conditions;
            /// Type erased pointer to this wait set's data
            void* data;
        }
        /// An rmw service request identifier
        alias rmw_request_id_t = rmw_request_id_s;
        /// An rmw service request identifier
        ...
        alias rmw_service_info_t = rmw_service_info_s;
        /// Meta-data for a service-related take.
        struct rmw_service_info_s
        {
            ...
            rmw_request_id_s request_id;
        }

        alias rmw_qos_reliability_policy_t = rmw_qos_reliability_policy_e;
   ...
   */
        ...
        enum RMW_QOS_POLICY_RELIABILITY_SYSTEM_DEFAULT = rmw_qos_reliability_policy_e
                .RMW_QOS_POLICY_RELIABILITY_SYSTEM_DEFAULT;
        enum RMW_QOS_POLICY_RELIABILITY_RELIABLE = rmw_qos_reliability_policy_e
                .RMW_QOS_POLICY_RELIABILITY_RELIABLE;
        enum RMW_QOS_POLICY_RELIABILITY_BEST_EFFORT = rmw_qos_reliability_policy_e
                .RMW_QOS_POLICY_RELIABILITY_BEST_EFFORT;
        enum RMW_QOS_POLICY_RELIABILITY_UNKNOWN = rmw_qos_reliability_policy_e
                .RMW_QOS_POLICY_RELIABILITY_UNKNOWN;
        enum RMW_QOS_POLICY_RELIABILITY_BEST_AVAILABLE = rmw_qos_reliability_policy_e
                .RMW_QOS_POLICY_RELIABILITY_BEST_AVAILABLE;
        /// QoS history enumerations describing how samples endure
        alias rmw_qos_history_policy_t = rmw_qos_history_policy_e;
        /// QoS history enumerations describing how samples endure
        ...
        enum RMW_QOS_POLICY_HISTORY_SYSTEM_DEFAULT = rmw_qos_history_policy_e
                .RMW_QOS_POLICY_HISTORY_SYSTEM_DEFAULT;
        enum RMW_QOS_POLICY_HISTORY_KEEP_LAST = rmw_qos_history_policy_e
                .RMW_QOS_POLICY_HISTORY_KEEP_LAST;
        enum RMW_QOS_POLICY_HISTORY_KEEP_ALL = rmw_qos_history_policy_e
                .RMW_QOS_POLICY_HISTORY_KEEP_ALL;
        enum RMW_QOS_POLICY_HISTORY_UNKNOWN = rmw_qos_history_policy_e
                .RMW_QOS_POLICY_HISTORY_UNKNOWN;
        /// QoS durability enumerations describing how samples persist
        alias rmw_qos_durability_policy_t = rmw_qos_durability_policy_e;
        /// QoS durability enumerations describing how samples persist
   ...
   */
        ...
        enum RMW_QOS_POLICY_DURABILITY_SYSTEM_DEFAULT = rmw_qos_durability_policy_e
                .RMW_QOS_POLICY_DURABILITY_SYSTEM_DEFAULT;
        enum RMW_QOS_POLICY_DURABILITY_TRANSIENT_LOCAL = rmw_qos_durability_policy_e
                .RMW_QOS_POLICY_DURABILITY_TRANSIENT_LOCAL;
        enum RMW_QOS_POLICY_DURABILITY_VOLATILE = rmw_qos_durability_policy_e
                .RMW_QOS_POLICY_DURABILITY_VOLATILE;
        enum RMW_QOS_POLICY_DURABILITY_UNKNOWN = rmw_qos_durability_policy_e
                .RMW_QOS_POLICY_DURABILITY_UNKNOWN;
        enum RMW_QOS_POLICY_DURABILITY_BEST_AVAILABLE = rmw_qos_durability_policy_e
        ...
        alias rmw_qos_liveliness_policy_t = rmw_qos_liveliness_policy_e;
        /// QoS liveliness enumerations that describe a publisher's reporting policy for its alive status.
        /// For a subscriber, these are its requirements for its topic's publishers.
   ...
   */
        ...
        enum RMW_QOS_POLICY_LIVELINESS_SYSTEM_DEFAULT = rmw_qos_liveliness_policy_e
                .RMW_QOS_POLICY_LIVELINESS_SYSTEM_DEFAULT;
        enum RMW_QOS_POLICY_LIVELINESS_AUTOMATIC = rmw_qos_liveliness_policy_e
                .RMW_QOS_POLICY_LIVELINESS_AUTOMATIC;
        enum RMW_QOS_POLICY_LIVELINESS_MANUAL_BY_NODE = rmw_qos_liveliness_policy_e
                .RMW_QOS_POLICY_LIVELINESS_MANUAL_BY_NODE;
        enum RMW_QOS_POLICY_LIVELINESS_MANUAL_BY_TOPIC = rmw_qos_liveliness_policy_e
                .RMW_QOS_POLICY_LIVELINESS_MANUAL_BY_TOPIC;
        enum RMW_QOS_POLICY_LIVELINESS_UNKNOWN = rmw_qos_liveliness_policy_e
                .RMW_QOS_POLICY_LIVELINESS_UNKNOWN;
        enum RMW_QOS_POLICY_LIVELINESS_BEST_AVAILABLE = rmw_qos_liveliness_policy_e
                .RMW_QOS_POLICY_LIVELINESS_BEST_AVAILABLE;
        /// ROS MiddleWare quality of service profile.
        alias rmw_qos_profile_t = rmw_qos_profile_s;
        /// ROS MiddleWare quality of service profile.
    ...
    */
            rmw_time_s liveliness_lease_duration;
   ...
   */
        ...
        alias rmw_message_info_t = rmw_message_info_s;
        /// Information describing an rmw message
   ...
   */
            c_ulong publication_sequence_number;
   ...
   */
            c_ulong reception_sequence_number;
   ...
   */
        ...
        enum RMW_QOS_POLICY_DEPTH_SYSTEM_DEFAULT = _Anonymous_1.RMW_QOS_POLICY_DEPTH_SYSTEM_DEFAULT;
        /// Type mapping of rcutils log severity types to rmw specific types.
        alias rmw_log_severity_t = _Anonymous_2;
        /// Type mapping of rcutils log severity types to rmw specific types.
        enum _Anonymous_2
        {
        ...
        enum RMW_LOG_SEVERITY_DEBUG = _Anonymous_2.RMW_LOG_SEVERITY_DEBUG;
        enum RMW_LOG_SEVERITY_INFO = _Anonymous_2.RMW_LOG_SEVERITY_INFO;
        enum RMW_LOG_SEVERITY_WARN = _Anonymous_2.RMW_LOG_SEVERITY_WARN;
        enum RMW_LOG_SEVERITY_ERROR = _Anonymous_2.RMW_LOG_SEVERITY_ERROR;
        enum RMW_LOG_SEVERITY_FATAL = _Anonymous_2.RMW_LOG_SEVERITY_FATAL;
 ...
 */
        ...
        bool rosidl_runtime_c__float__Sequence__are_equal(const(rosidl_runtime_c__float__Sequence)*,
                const(rosidl_runtime_c__float__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__float__Sequence__copy(const(rosidl_runtime_c__float__Sequence)*,
                rosidl_runtime_c__float__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__double__Sequence__are_equal(const(rosidl_runtime_c__double__Sequence)*,
                const(rosidl_runtime_c__double__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__double__Sequence__copy(const(rosidl_runtime_c__double__Sequence)*,
                rosidl_runtime_c__double__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__long_double__Sequence__are_equal(const(rosidl_runtime_c__long_double__Sequence)*,
                const(rosidl_runtime_c__long_double__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__long_double__Sequence__copy(const(rosidl_runtime_c__long_double__Sequence)*,
                rosidl_runtime_c__long_double__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__char__Sequence__are_equal(const(rosidl_runtime_c__char__Sequence)*,
                const(rosidl_runtime_c__char__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__char__Sequence__copy(const(rosidl_runtime_c__char__Sequence)*,
                rosidl_runtime_c__char__Sequence*) @nogc nothrow;

        bool rosidl_runtime_c__wchar__Sequence__copy(const(rosidl_runtime_c__wchar__Sequence)*,
                rosidl_runtime_c__wchar__Sequence*) @nogc nothrow;

        bool rosidl_runtime_c__wchar__Sequence__are_equal(const(rosidl_runtime_c__wchar__Sequence)*,
                const(rosidl_runtime_c__wchar__Sequence)*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__boolean__Sequence__are_equal(const(rosidl_runtime_c__boolean__Sequence)*,
                const(rosidl_runtime_c__boolean__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__boolean__Sequence__copy(const(rosidl_runtime_c__boolean__Sequence)*,
                rosidl_runtime_c__boolean__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__octet__Sequence__are_equal(const(rosidl_runtime_c__octet__Sequence)*,
                const(rosidl_runtime_c__octet__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__octet__Sequence__copy(const(rosidl_runtime_c__octet__Sequence)*,
                rosidl_runtime_c__octet__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__uint8__Sequence__are_equal(const(rosidl_runtime_c__uint8__Sequence)*,
                const(rosidl_runtime_c__uint8__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__uint8__Sequence__copy(const(rosidl_runtime_c__uint8__Sequence)*,
                rosidl_runtime_c__uint8__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__int8__Sequence__are_equal(const(rosidl_runtime_c__int8__Sequence)*,
                const(rosidl_runtime_c__int8__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__int8__Sequence__copy(const(rosidl_runtime_c__int8__Sequence)*,
                rosidl_runtime_c__int8__Sequence*) @nogc nothrow;

        bool rosidl_runtime_c__uint16__Sequence__copy(const(rosidl_runtime_c__uint16__Sequence)*,
                rosidl_runtime_c__uint16__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__uint16__Sequence__are_equal(const(rosidl_runtime_c__uint16__Sequence)*,
                const(rosidl_runtime_c__uint16__Sequence)*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__int16__Sequence__are_equal(const(rosidl_runtime_c__int16__Sequence)*,
                const(rosidl_runtime_c__int16__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__int16__Sequence__copy(const(rosidl_runtime_c__int16__Sequence)*,
                rosidl_runtime_c__int16__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__uint32__Sequence__copy(const(rosidl_runtime_c__uint32__Sequence)*,
                rosidl_runtime_c__uint32__Sequence*) @nogc nothrow;

        bool rosidl_runtime_c__uint32__Sequence__are_equal(const(rosidl_runtime_c__uint32__Sequence)*,
                const(rosidl_runtime_c__uint32__Sequence)*) @nogc nothrow;

        void rosidl_runtime_c__int32__Sequence__fini(rosidl_runtime_c__int32__Sequence*) @nogc nothrow;

        bool rosidl_runtime_c__int32__Sequence__are_equal(const(rosidl_runtime_c__int32__Sequence)*,
                const(rosidl_runtime_c__int32__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__int32__Sequence__init(rosidl_runtime_c__int32__Sequence*, c_ulong) @nogc nothrow;

        bool rosidl_runtime_c__int32__Sequence__copy(const(rosidl_runtime_c__int32__Sequence)*,
                rosidl_runtime_c__int32__Sequence*) @nogc nothrow;

        bool rosidl_runtime_c__uint64__Sequence__are_equal(const(rosidl_runtime_c__uint64__Sequence)*,
                const(rosidl_runtime_c__uint64__Sequence)*) @nogc nothrow;

        bool rosidl_runtime_c__uint64__Sequence__copy(const(rosidl_runtime_c__uint64__Sequence)*,
                rosidl_runtime_c__uint64__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__int64__Sequence__copy(const(rosidl_runtime_c__int64__Sequence)*,
                rosidl_runtime_c__int64__Sequence*) @nogc nothrow;

        bool rosidl_runtime_c__int64__Sequence__are_equal(const(rosidl_runtime_c__int64__Sequence)*,
                const(rosidl_runtime_c__int64__Sequence)*) @nogc nothrow;
 ...
 */
        ...
        bool rosidl_runtime_c__bool__Sequence__are_equal(const(rosidl_runtime_c__boolean__Sequence)*,
                const(rosidl_runtime_c__boolean__Sequence)*) @nogc nothrow;
        /** See #ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(bool) */
        bool rosidl_runtime_c__bool__Sequence__copy(const(rosidl_runtime_c__boolean__Sequence)*,
                rosidl_runtime_c__boolean__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__byte__Sequence__are_equal(const(rosidl_runtime_c__octet__Sequence)*,
                const(rosidl_runtime_c__octet__Sequence)*) @nogc nothrow;
        /** See #ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(byte) */
        bool rosidl_runtime_c__byte__Sequence__copy(const(rosidl_runtime_c__octet__Sequence)*,
                rosidl_runtime_c__octet__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__float32__Sequence__are_equal(const(rosidl_runtime_c__float__Sequence)*,
                const(rosidl_runtime_c__float__Sequence)*) @nogc nothrow;
        /** See #ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(float32) */
        bool rosidl_runtime_c__float32__Sequence__copy(const(rosidl_runtime_c__float__Sequence)*,
                rosidl_runtime_c__float__Sequence*) @nogc nothrow;
        ...
        bool rosidl_runtime_c__float64__Sequence__are_equal(const(rosidl_runtime_c__double__Sequence)*,
                const(rosidl_runtime_c__double__Sequence)*) @nogc nothrow;
        /** See #ROSIDL_RUNTIME_C__DECLARE_PRIMITIVE_SEQUENCE_COPY(float64) */
        bool rosidl_runtime_c__float64__Sequence__copy(const(rosidl_runtime_c__double__Sequence)*,
                rosidl_runtime_c__double__Sequence*) @nogc nothrow;
 ...
 *   allocation fails.
 */
        bool rosidl_runtime_c__String__copy(const(rosidl_runtime_c__String)*,
                rosidl_runtime_c__String*) @nogc nothrow;
 ...
 *   otherwise false.
 */
        bool rosidl_runtime_c__String__are_equal(const(rosidl_runtime_c__String)*,
                const(rosidl_runtime_c__String)*) @nogc nothrow;
 ...
 */
        bool rosidl_runtime_c__String__Sequence__are_equal(const(rosidl_runtime_c__String__Sequence)*,
                const(rosidl_runtime_c__String__Sequence)*) @nogc nothrow;
 ...
 *   allocation fails.
 */
        bool rosidl_runtime_c__String__Sequence__copy(const(rosidl_runtime_c__String__Sequence)*,
                rosidl_runtime_c__String__Sequence*) @nogc nothrow;
 ...
 *   in size and content, otherwise false.
 */
        bool rosidl_runtime_c__U16String__are_equal(const(rosidl_runtime_c__U16String)*,
                const(rosidl_runtime_c__U16String)*) @nogc nothrow;
 ...
 *   allocation fails.
 */
        bool rosidl_runtime_c__U16String__copy(const(rosidl_runtime_c__U16String)*,
                rosidl_runtime_c__U16String*) @nogc nothrow;
 ...
 *   in size and content, otherwise false.
 */
        bool rosidl_runtime_c__U16String__Sequence__are_equal(const(rosidl_runtime_c__U16String__Sequence)*,
                const(rosidl_runtime_c__U16String__Sequence)*) @nogc nothrow;
 ...
 *   allocation fails.
 */
        bool rosidl_runtime_c__U16String__Sequence__copy(const(rosidl_runtime_c__U16String__Sequence)*,
                rosidl_runtime_c__U16String__Sequence*) @nogc nothrow;
        ...
        static if (!is(typeof(RMW_MESSAGE_INFO_SEQUENCE_NUMBER_UNSUPPORTED)))
        {
            private enum enumMixinStr_RMW_MESSAGE_INFO_SEQUENCE_NUMBER_UNSUPPORTED = `enum RMW_MESSAGE_INFO_SEQUENCE_NUMBER_UNSUPPORTED = ( 18446744073709551615UL );`;
            static if (is(typeof({
                        mixin(enumMixinStr_RMW_MESSAGE_INFO_SEQUENCE_NUMBER_UNSUPPORTED);
                    })))
            {
                mixin(enumMixinStr_RMW_MESSAGE_INFO_SEQUENCE_NUMBER_UNSUPPORTED);
            }
        ...
        static if (!is(typeof(RMW_QOS_LIVELINESS_LEASE_DURATION_BEST_AVAILABLE)))
        {
            private enum enumMixinStr_RMW_QOS_LIVELINESS_LEASE_DURATION_BEST_AVAILABLE = `enum RMW_QOS_LIVELINESS_LEASE_DURATION_BEST_AVAILABLE = { 9223372036L , 854775806L };`;
            static if (is(typeof({
                        mixin(enumMixinStr_RMW_QOS_LIVELINESS_LEASE_DURATION_BEST_AVAILABLE);
                    })))
            {
                mixin(enumMixinStr_RMW_QOS_LIVELINESS_LEASE_DURATION_BEST_AVAILABLE);
            }
        ...
        {
            private enum enumMixinStr_RMW_QOS_LIVELINESS_LEASE_DURATION_DEFAULT = `enum RMW_QOS_LIVELINESS_LEASE_DURATION_DEFAULT = RMW_DURATION_UNSPECIFIED;`;
            static if (is(typeof({
        ...
        {
            private enum enumMixinStr_RMW_QOS_LIFESPAN_DEFAULT = `enum RMW_QOS_LIFESPAN_DEFAULT = RMW_DURATION_UNSPECIFIED;`;
        ...
        static if (!is(typeof(RMW_QOS_DEADLINE_BEST_AVAILABLE)))
        {
            private enum enumMixinStr_RMW_QOS_DEADLINE_BEST_AVAILABLE = `enum RMW_QOS_DEADLINE_BEST_AVAILABLE = { 9223372036L , 854775806L };`;
            static if (is(typeof({
                        mixin(enumMixinStr_RMW_QOS_DEADLINE_BEST_AVAILABLE);
                    })))
            {
                mixin(enumMixinStr_RMW_QOS_DEADLINE_BEST_AVAILABLE);
            }
        ...
        {
            private enum enumMixinStr_RMW_QOS_DEADLINE_DEFAULT = `enum RMW_QOS_DEADLINE_DEFAULT = RMW_DURATION_UNSPECIFIED;`;
        ...
        static if (!is(typeof(RMW_DURATION_UNSPECIFIED)))
        {
            private enum enumMixinStr_RMW_DURATION_UNSPECIFIED = `enum RMW_DURATION_UNSPECIFIED = { 0L , 0L };`;
            static if (is(typeof({ mixin(enumMixinStr_RMW_DURATION_UNSPECIFIED); })))
            {
                mixin(enumMixinStr_RMW_DURATION_UNSPECIFIED);
            }
        }

        static if (!is(typeof(RMW_DURATION_INFINITE)))
        {
            private enum enumMixinStr_RMW_DURATION_INFINITE = `enum RMW_DURATION_INFINITE = { 9223372036L , 854775807L };`;
            static if (is(typeof({ mixin(enumMixinStr_RMW_DURATION_INFINITE); })))
            {
                mixin(enumMixinStr_RMW_DURATION_INFINITE);
            }
        }
        ...
        {
            private enum enumMixinStr_RCUTILS_LOGGING_AUTOINIT = `enum RCUTILS_LOGGING_AUTOINIT = do { if ( __builtin_expect ( ( ! g_rcutils_logging_initialized ) , 0 ) ) { if ( rcutils_logging_initialize ( ) != 0 ) { RCUTILS_SAFE_FWRITE_TO_STDERR ( "[rcutils|" "/tmp/package.d.tmp" ":" "17283" "] error initializing logging: " ) ; RCUTILS_SAFE_FWRITE_TO_STDERR ( rcutils_get_error_string ( ) . str ) ; RCUTILS_SAFE_FWRITE_TO_STDERR ( "\n" ) ; rcutils_reset_error ( ) ; } } } while ( 0 );`;
        ...
        static if (!is(typeof(RCL_RET_LIFECYCLE_STATE_NOT_REGISTERED)))
        {
            private enum enumMixinStr_RCL_RET_LIFECYCLE_STATE_NOT_REGISTERED = `enum RCL_RET_LIFECYCLE_STATE_NOT_REGISTERED = 3001;`;
            static if (is(typeof({
                        mixin(enumMixinStr_RCL_RET_LIFECYCLE_STATE_NOT_REGISTERED);
                    })))
            {
                mixin(enumMixinStr_RCL_RET_LIFECYCLE_STATE_NOT_REGISTERED);
            }
        ...
        static if (!is(typeof(RCL_RET_LIFECYCLE_STATE_REGISTERED)))
        {
            private enum enumMixinStr_RCL_RET_LIFECYCLE_STATE_REGISTERED = `enum RCL_RET_LIFECYCLE_STATE_REGISTERED = 3000;`;
            static if (is(typeof({
                        mixin(enumMixinStr_RCL_RET_LIFECYCLE_STATE_REGISTERED);
                    })))
            {
                mixin(enumMixinStr_RCL_RET_LIFECYCLE_STATE_REGISTERED);
            }
