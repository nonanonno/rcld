 ...
 */
        int rcl_arguments_get_log_levels(const(rcl_arguments_t)*, rcl_log_levels_t*) @nogc nothrow;
 ...
 */
        const(rcl_init_options_t)* rcl_context_get_init_options(const(rcl_context_t)*) @nogc nothrow;
 ...
 */
        c_ulong rcl_context_get_instance_id(const(rcl_context_t)*) @nogc nothrow;
 ...
 */
        int rcl_context_get_domain_id(rcl_context_t*, c_ulong*) @nogc nothrow;
 ...
 */
        bool rcl_context_is_valid(const(rcl_context_t)*) @nogc nothrow;
 ...
 */
        ...
        enum RCL_SUBSCRIPTION_MESSAGE_LOST = rcl_subscription_event_type_t
 ...
 */
        bool rcl_event_is_valid(const(rcl_event_t)*) @nogc nothrow;
 ...
 */
        int rcl_wait_for_publishers(const(rcl_node_t)*, rcutils_allocator_t*,
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurred.
 */
        int rcl_wait_for_subscribers(const(rcl_node_t)*,
                rcutils_allocator_t*, const(char)*, const(c_ulong), c_long, bool*) @nogc nothrow;
 ...
 */
        int rcl_init_options_get_domain_id(const(rcl_init_options_t)*, c_ulong*) @nogc nothrow;
 ...
 * \return a rcl_log_levels_t struct with members initialized to zero value.
 */
        rcl_log_levels_t rcl_get_zero_initialized_log_levels() @nogc nothrow;
 ...
 * \return #RCL_RET_BAD_ALLOC if allocating memory failed.
 */
        int rcl_log_levels_init(rcl_log_levels_t*, const(rcutils_allocator_t)*, c_ulong) @nogc nothrow;
 ...
 * \return #RCL_RET_BAD_ALLOC if allocating memory failed.
 */
        int rcl_log_levels_copy(const(rcl_log_levels_t)*, rcl_log_levels_t*) @nogc nothrow;
 ...
 */
        int rcl_log_levels_fini(rcl_log_levels_t*) @nogc nothrow;
 ...
 */
        int rcl_log_levels_shrink_to_size(rcl_log_levels_t*) @nogc nothrow;
 ...
 */
        int rcl_log_levels_add_logger_setting(rcl_log_levels_t*,
 ...
 * \return #RCL_RET_ERROR if an unspecified error occurs.
 */
        int rcl_node_resolve_name(const(rcl_node_t)*, const(char)*,
                rcutils_allocator_t, bool, bool, char**) @nogc nothrow;
 ...
 */
   ...
   */
        ...
        alias rmw_requested_qos_incompatible_event_status_t = rmw_qos_incompatible_event_status_t;
        /// Event state for a publisher's 'RMW_EVENT_OFFERED_QOS_INCOMPATIBLE' events.
        alias rmw_offered_qos_incompatible_event_status_t = rmw_qos_incompatible_event_status_t;
 ...
 */
        ...
        enum RMW_QOS_POLICY_INVALID = rmw_qos_policy_kind_t.RMW_QOS_POLICY_INVALID;
        enum RMW_QOS_POLICY_DURABILITY = rmw_qos_policy_kind_t.RMW_QOS_POLICY_DURABILITY;
        enum RMW_QOS_POLICY_DEADLINE = rmw_qos_policy_kind_t.RMW_QOS_POLICY_DEADLINE;
        enum RMW_QOS_POLICY_LIVELINESS = rmw_qos_policy_kind_t.RMW_QOS_POLICY_LIVELINESS;
        enum RMW_QOS_POLICY_RELIABILITY = rmw_qos_policy_kind_t.RMW_QOS_POLICY_RELIABILITY;
        enum RMW_QOS_POLICY_HISTORY = rmw_qos_policy_kind_t.RMW_QOS_POLICY_HISTORY;
        enum RMW_QOS_POLICY_LIFESPAN = rmw_qos_policy_kind_t.RMW_QOS_POLICY_LIFESPAN;
        enum RMW_QOS_POLICY_DEPTH = rmw_qos_policy_kind_t.RMW_QOS_POLICY_DEPTH;
        enum RMW_QOS_POLICY_LIVELINESS_LEASE_DURATION = rmw_qos_policy_kind_t
                .RMW_QOS_POLICY_LIVELINESS_LEASE_DURATION;
        enum RMW_QOS_POLICY_AVOID_ROS_NAMESPACE_CONVENTIONS = rmw_qos_policy_kind_t
        ...
        enum RMW_QOS_COMPATIBILITY_OK = rmw_qos_compatibility_type_t.RMW_QOS_COMPATIBILITY_OK;
        enum RMW_QOS_COMPATIBILITY_WARNING = rmw_qos_compatibility_type_t
                .RMW_QOS_COMPATIBILITY_WARNING;
        enum RMW_QOS_COMPATIBILITY_ERROR = rmw_qos_compatibility_type_t.RMW_QOS_COMPATIBILITY_ERROR;
 ...
 */
        int rmw_qos_profile_check_compatible(const(rmw_qos_profile_t),
                const(rmw_qos_profile_t), rmw_qos_compatibility_type_t*, char*, c_ulong) @nogc nothrow;
 ...
 */
        rmw_node_t* rmw_create_node(rmw_context_t*, const(char)*, const(char)*) @nogc nothrow;
 ...
 */
        ...
        bool rmw_time_equal(const(rmw_time_t), const(rmw_time_t)) @nogc nothrow;
        /// Return the total nanosecond representation of a time.
        /**
  * \return INT64_MAX if input is too large to store in 64 bits
  */
        c_long rmw_time_total_nsec(const(rmw_time_t)) @nogc nothrow;
  ...
  */
        rmw_time_t rmw_time_from_nsec(const(c_long)) @nogc nothrow;
        /// Ensure that an rmw_time_t does not have nanoseconds > 1 second.
        rmw_time_t rmw_time_normalize(const(rmw_time_t)) @nogc nothrow;
 ...
 */
        ...
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_NOT_REQUIRED = rmw_unique_network_flow_endpoints_requirement_t
                .RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_NOT_REQUIRED;
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_STRICTLY_REQUIRED = rmw_unique_network_flow_endpoints_requirement_t
                .RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_STRICTLY_REQUIRED;
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_OPTIONALLY_REQUIRED = rmw_unique_network_flow_endpoints_requirement_t
                .RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_OPTIONALLY_REQUIRED;
        enum RMW_UNIQUE_NETWORK_FLOW_ENDPOINTS_SYSTEM_DEFAULT = rmw_unique_network_flow_endpoints_requirement_t
 ...
 */
        ...
        {
            private enum enumMixinStr_RCUTILS_LOGGING_AUTOINIT = `enum RCUTILS_LOGGING_AUTOINIT = do { if ( __builtin_expect ( ( ! g_rcutils_logging_initialized ) , 0 ) ) { if ( rcutils_logging_initialize ( ) != 0 ) { RCUTILS_SAFE_FWRITE_TO_STDERR ( "[rcutils|" "/tmp/package.d.tmp" ":" "15701" "] error initializing logging: " ) ; RCUTILS_SAFE_FWRITE_TO_STDERR ( rcutils_get_error_string ( ) . str ) ; RCUTILS_SAFE_FWRITE_TO_STDERR ( "\n" ) ; rcutils_reset_error ( ) ; } } } while ( 0 );`;
