...
struct SetParameters_Response
{
    ...
    {
        rcl_interfaces__msg__SetParametersResult__Sequence__init(&dst.results, src.results.length);
...
struct DescribeParameters_Request
{
    ...
    static void convert(in DescribeParameters_Request src, ref DescribeParameters_Request.CType dst)
    {
        rosidl_runtime_c__String__Sequence__init(&dst.names, src.names.length);
        foreach (i; 0U .. src.names.length)
        {
    ...
    static void convert(in DescribeParameters_Request.CType src, ref DescribeParameters_Request dst)
    {
        dst.names.length = src.names.size;
        foreach (i; 0U .. dst.names.length)
        {
...
struct DescribeParameters_Response
{
    ...
    static void convert(in DescribeParameters_Response.CType src, ref DescribeParameters_Response dst)
    {
...
struct GetParameterTypes_Request
{
    ...
    static void convert(in GetParameterTypes_Request src, ref GetParameterTypes_Request.CType dst)
    {
        rosidl_runtime_c__String__Sequence__init(&dst.names, src.names.length);
        foreach (i; 0U .. src.names.length)
        {
...
struct GetParameterTypes_Response
{
    ...
    static void convert(in GetParameterTypes_Response src, ref GetParameterTypes_Response.CType dst)
    {
    ...
    static void convert(in GetParameterTypes_Response.CType src, ref GetParameterTypes_Response dst)
    {
